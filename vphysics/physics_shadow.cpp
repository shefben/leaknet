...
void CShadowController::AttachObject( void )
{
	...
	{
		// VXP: Initial thing was a huge 1e15f! Why? IVP_Core::calc_calc() was struggling a big time about it.
		// get_rot_inertia() returned inf! There was fucking huge numbers!
		IVP_U_Float_Point ri( VPHYSICS_MAX_INERTIA, VPHYSICS_MAX_INERTIA, VPHYSICS_MAX_INERTIA );
	...
	if ( !m_allowPhysicsMovement )
	{
		...
		// UPD: I'm actually will use VPHYSICS_MAX_MASS to unify all the max mass stuff in the engine
