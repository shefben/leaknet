...
{
	MathLib_Init( 2.2f, 2.2f, 0.0f, 2, false, false, true );	// NJS: Why no SSE?
...
#if defined( _WIN32 ) // VXP: Do this only for Windows
...
void CMaterialSystem::AllocateLightmapTexture( int lightmap )
{
	...
	{
		Q_snprintf( debugName, sizeof( debugName ), "[lightmap %d] - DX<70", lightmap );
	...
	else
	{
		...
		{
			Q_snprintf( debugName, sizeof( debugName ), "[lightmap %d - ALPHA]", lightmap );
...
void CMaterialSystem::AllocateStandardTextures( )
{
	...
	// don't mipmap lightmaps
	g_pShaderAPI->CreateTexture( FULLBRIGHT_LIGHTMAP_TEXID, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_MANAGED, "[FULLBRIGHT_LIGHTMAP_TEXID]" );
	...
	g_pShaderAPI->CreateTexture( BLACK_TEXID, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_MANAGED, "BLACK_TEXID" );
	...
	// allocate a black single texel texture
	// lightmap at lightmapPage = -2
	g_pShaderAPI->CreateTexture( GREY_TEXID, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_MANAGED, "GREY_TEXID" );
	...
	g_pShaderAPI->CreateTexture( FLAT_NORMAL_TEXTURE, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_MANAGED, "FLAT_NORMAL_TEXTURE" );
	...
	g_pShaderAPI->CreateTexture( FULLBRIGHT_BUMPED_LIGHTMAP_TEXID, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_MANAGED, "FULLBRIGHT_BUMPED_LIGHTMAP_TEXID" );
...
//	g_pShaderAPI->CreateTexture( FRAMESYNC_TEXID1, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_DYNAMIC, "FRAMESYNC_TEXID1" );
//	g_pShaderAPI->ModifyTexture( FRAMESYNC_TEXID1 );
//	texel[0] = texel[1] = texel[2] = 0;
//	g_pShaderAPI->TexImage2D( 0, 0, IMAGE_FORMAT_RGB888, 1, 1, IMAGE_FORMAT_RGB888, texel );

//	g_pShaderAPI->CreateTexture( FRAMESYNC_TEXID2, 1, 1, IMAGE_FORMAT_RGB888, 1, 1, TEXTURE_CREATE_DYNAMIC, "FRAMESYNC_TEXID2" );
...
void CMaterialSystem::ReleaseLightmapPages()
{
	for( int i = 0; i < m_NumLightmapPages; i++ )
	{
		...
		g_pShaderAPI->DeleteTexture( i + FIRST_LIGHTMAP_ALPHA_TEXID );
	}
}
