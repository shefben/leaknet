...
public:
	...
	void CreateDepthTexture( unsigned int textureNum, ImageFormat renderFormat, int width, int height, const char *pDebugName );
...
void CShaderAPIEmpty::CreateDepthTexture( unsigned int textureNum, ImageFormat renderFormat, int width, int height, const char *pDebugName )
{
}
