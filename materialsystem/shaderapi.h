...
public:
	...
	virtual void CreateTexture( unsigned int textureNum, int width, int height,
		ImageFormat dstImageFormat, int numMipLevels, int numCopies, int flags = 0, const char *pDebugName = "" ) = 0;
	virtual void DeleteTexture( unsigned int textureNum ) = 0;
	virtual void CreateDepthTexture( unsigned int textureNum, ImageFormat renderTargetFormat, int width, int height, const char *pDebugName ) = 0;
