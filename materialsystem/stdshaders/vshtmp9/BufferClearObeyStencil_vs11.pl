push @output, "vs.1.1																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(1)\n";
...
push @output, "mov oPos.xyz, $vPos.xyz																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(4)\n";
push @output, "mov oPos.w, $cOne																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(5)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(6)\n";
