push @output, "vs.1.1																								; LINEINFO(vortwarp_vs11.vsh)(1)\n";
...
&AllocateRegister( \$tmp, "\$tmp" );																								
push @output, "sub $tmp.xyz, $worldPos, c93																								; LINEINFO(vortwarp_vs11.vsh)(10)\n";
push @output, "mul $tmp.xy, $tmp, c92																								; LINEINFO(vortwarp_vs11.vsh)(11)\n";
push @output, "add $worldPos.xyz, $tmp, c93																								; LINEINFO(vortwarp_vs11.vsh)(12)\n";
&FreeRegister( \$tmp, "\$tmp" );																								
if( $g_numBones != 0 )																								
{																								
&Normalize( $worldNormal );																								
}																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(vortwarp_vs11.vsh)(20)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(vortwarp_vs11.vsh)(21)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(vortwarp_vs11.vsh)(22)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(vortwarp_vs11.vsh)(23)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(vortwarp_vs11.vsh)(24)\n";
...
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(vortwarp_vs11.vsh)(33)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(vortwarp_vs11.vsh)(34)\n";
&AllocateRegister( \$tmp2, "\$tmp2" );																								
push @output, "dp4 $tmp2.x, $vTexCoord0, c90																								; LINEINFO(vortwarp_vs11.vsh)(37)\n";
push @output, "dp4 $tmp2.y, $vTexCoord0, c91																								; LINEINFO(vortwarp_vs11.vsh)(38)\n";
push @output, "add oT1.xy, $tmp2, c94																								; LINEINFO(vortwarp_vs11.vsh)(39)\n";
&FreeRegister( \$tmp2, "\$tmp2" );																								
push @output, "mov oT2, $cZero																								; LINEINFO(vortwarp_vs11.vsh)(42)\n";
