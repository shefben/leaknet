push @output, "vs.1.1																								; LINEINFO(basetimeslightmapwet.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(5)\n";
push @output, "; Vertex blending																								; LINEINFO(basetimeslightmapwet.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(7)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Transform position from object to world																								; LINEINFO(basetimeslightmapwet.vsh)(11)\n";
push @output, "dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(basetimeslightmapwet.vsh)(12)\n";
push @output, "dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(basetimeslightmapwet.vsh)(13)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(basetimeslightmapwet.vsh)(14)\n";
push @output, "mov $worldPos.w, $cOne																								; LINEINFO(basetimeslightmapwet.vsh)(15)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform to camera space																								; LINEINFO(basetimeslightmapwet.vsh)(19)\n";
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(basetimeslightmapwet.vsh)(20)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(basetimeslightmapwet.vsh)(21)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(basetimeslightmapwet.vsh)(22)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(basetimeslightmapwet.vsh)(23)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(basetimeslightmapwet.vsh)(25)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(27)\n";
push @output, "; Fog																								; LINEINFO(basetimeslightmapwet.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(29)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(34)\n";
push @output, "; Lighting																								; LINEINFO(basetimeslightmapwet.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(36)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(basetimeslightmapwet.vsh)(38)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(basetimeslightmapwet.vsh)(39)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(basetimeslightmapwet.vsh)(40)\n";
push @output, "; to environment map space. 																								; LINEINFO(basetimeslightmapwet.vsh)(41)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(basetimeslightmapwet.vsh)(42)\n";
push @output, "dp3 oT1.x, $vTangentS, $cModel0																								; LINEINFO(basetimeslightmapwet.vsh)(44)\n";
push @output, "dp3 oT1.y, $vTangentS, $cModel1																								; LINEINFO(basetimeslightmapwet.vsh)(45)\n";
push @output, "dp3 oT1.z, $vTangentS, $cModel2																								; LINEINFO(basetimeslightmapwet.vsh)(46)\n";
push @output, "dp3 oT2.x, $vTangentT, $cModel0																								; LINEINFO(basetimeslightmapwet.vsh)(48)\n";
push @output, "dp3 oT2.y, $vTangentT, $cModel1																								; LINEINFO(basetimeslightmapwet.vsh)(49)\n";
push @output, "dp3 oT2.z, $vTangentT, $cModel2																								; LINEINFO(basetimeslightmapwet.vsh)(50)\n";
push @output, "dp3 oT3.x, $vNormal, $cModel0																								; LINEINFO(basetimeslightmapwet.vsh)(52)\n";
push @output, "dp3 oT3.y, $vNormal, $cModel1																								; LINEINFO(basetimeslightmapwet.vsh)(53)\n";
push @output, "dp3 oT3.z, $vNormal, $cModel2																								; LINEINFO(basetimeslightmapwet.vsh)(54)\n";
&AllocateRegister( \$vertexToCamera, "\$vertexToCamera" );																								
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(basetimeslightmapwet.vsh)(58)\n";
push @output, "sub $vertexToCamera, $cEyePos, $worldPos																								; LINEINFO(basetimeslightmapwet.vsh)(59)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Move it into the w component of the texture coords, as the wacky																								; LINEINFO(basetimeslightmapwet.vsh)(63)\n";
push @output, "; pixel shader wants it there.																								; LINEINFO(basetimeslightmapwet.vsh)(64)\n";
push @output, "mov oT1.w, $vertexToCamera.x																								; LINEINFO(basetimeslightmapwet.vsh)(65)\n";
push @output, "mov oT2.w, $vertexToCamera.y																								; LINEINFO(basetimeslightmapwet.vsh)(66)\n";
push @output, "mov oT3.w, $vertexToCamera.z																								; LINEINFO(basetimeslightmapwet.vsh)(67)\n";
&FreeRegister( \$vertexToCamera, "\$vertexToCamera" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(71)\n";
push @output, "; Texture coordinates																								; LINEINFO(basetimeslightmapwet.vsh)(72)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(basetimeslightmapwet.vsh)(73)\n";
push @output, "; Just copy the texture coordinates	for the normal map																								; LINEINFO(basetimeslightmapwet.vsh)(75)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(basetimeslightmapwet.vsh)(76)\n";
