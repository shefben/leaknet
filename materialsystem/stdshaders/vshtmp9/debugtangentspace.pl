push @output, "vs.1.1																								; LINEINFO(debugtangentspace.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(debugtangentspace.vsh)(5)\n";
push @output, "; Vertex blending 																								; LINEINFO(debugtangentspace.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(debugtangentspace.vsh)(7)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(debugtangentspace.vsh)(12)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(debugtangentspace.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(debugtangentspace.vsh)(14)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(debugtangentspace.vsh)(18)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(debugtangentspace.vsh)(19)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(debugtangentspace.vsh)(20)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(debugtangentspace.vsh)(21)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(debugtangentspace.vsh)(22)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; stick the normal in the color channel																								; LINEINFO(debugtangentspace.vsh)(26)\n";
push @output, "mov oD0.xyz, $worldNormal.xyz																								; LINEINFO(debugtangentspace.vsh)(27)\n";
push @output, "mov oD0.w, $cOne				; make sure all components are defined																								; LINEINFO(debugtangentspace.vsh)(28)\n";
