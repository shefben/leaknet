push @output, "vs.1.1																								; LINEINFO(vortwarp_unlit_vs11.vsh)(1)\n";
...
&AllocateRegister( \$tmp, "\$tmp" );																								
push @output, "sub $tmp.xyz, $worldPos, c93																								; LINEINFO(vortwarp_unlit_vs11.vsh)(10)\n";
push @output, "mul $tmp.xy, $tmp, c92																								; LINEINFO(vortwarp_unlit_vs11.vsh)(11)\n";
push @output, "add $worldPos.xyz, $tmp, c93																								; LINEINFO(vortwarp_unlit_vs11.vsh)(12)\n";
&FreeRegister( \$tmp, "\$tmp" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(vortwarp_unlit_vs11.vsh)(15)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(vortwarp_unlit_vs11.vsh)(16)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(vortwarp_unlit_vs11.vsh)(17)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(vortwarp_unlit_vs11.vsh)(18)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(vortwarp_unlit_vs11.vsh)(19)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, "mov oD0, $cHalf																								; LINEINFO(vortwarp_unlit_vs11.vsh)(24)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "dp4 oT0.x, $vTexCoord0, c90																								; LINEINFO(vortwarp_unlit_vs11.vsh)(27)\n";
push @output, "dp4 oT0.y, $vTexCoord0, c91																								; LINEINFO(vortwarp_unlit_vs11.vsh)(28)\n";
&AllocateRegister( \$tmp2, "\$tmp2" );																								
push @output, "dp4 $tmp2.x, $vTexCoord0, c90																								; LINEINFO(vortwarp_unlit_vs11.vsh)(31)\n";
push @output, "dp4 $tmp2.y, $vTexCoord0, c91																								; LINEINFO(vortwarp_unlit_vs11.vsh)(32)\n";
push @output, "add oT1.xy, $tmp2, c94																								; LINEINFO(vortwarp_unlit_vs11.vsh)(33)\n";
&FreeRegister( \$tmp2, "\$tmp2" );																								
push @output, "mov oT2, $cZero																								; LINEINFO(vortwarp_unlit_vs11.vsh)(36)\n";
