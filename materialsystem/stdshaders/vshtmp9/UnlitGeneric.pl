push @output, "vs.1.1																								; LINEINFO(UnlitGeneric.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(3)\n";
 	 push @output, ";	 c20	 = Modulation color  BUGBUGBUG																								; LINEINFO(UnlitGeneric_inc.vsh)(4)\n";
 	 push @output, ";	 c90-c91 = Base texture transform																								; LINEINFO(UnlitGeneric_inc.vsh)(5)\n";
     push @output, ";    c92-c93 = Mask texture transform																								; LINEINFO(UnlitGeneric_inc.vsh)(6)\n";
     push @output, ";    c94-c95 = Detail texture transform																								; LINEINFO(UnlitGeneric_inc.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(8)\n";
sub UnlitGeneric																								
{																								
	local( $detail ) = shift;																								
	local( $envmap ) = shift;																								
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(20)\n";
	push @output, "	; Vertex blending																								; LINEINFO(UnlitGeneric_inc.vsh)(21)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(22)\n";
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(34)\n";
	push @output, "	; Transform the position from world to proj space																								; LINEINFO(UnlitGeneric_inc.vsh)(35)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(36)\n";
	&AllocateRegister( \$projPos, "\$projPos" );																								
	push @output, "	dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(UnlitGeneric_inc.vsh)(40)\n";
	push @output, "	dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(UnlitGeneric_inc.vsh)(41)\n";
	push @output, "	dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(UnlitGeneric_inc.vsh)(42)\n";
	push @output, "	dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(UnlitGeneric_inc.vsh)(43)\n";
	push @output, "	mov oPos, $projPos																								; LINEINFO(UnlitGeneric_inc.vsh)(44)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(46)\n";
	push @output, "	; Fog																								; LINEINFO(UnlitGeneric_inc.vsh)(47)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(48)\n";
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(59)\n";
	push @output, "	; Texture coordinates (use world-space normal for envmap, tex transform for mask)																								; LINEINFO(UnlitGeneric_inc.vsh)(60)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(61)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, c90	; FIXME																								; LINEINFO(UnlitGeneric_inc.vsh)(62)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, c91	; FIXME																								; LINEINFO(UnlitGeneric_inc.vsh)(63)\n";
	if( $envmap )																								
	{																								
		if( $envmapcameraspace )																								
		{																								
			&AllocateRegister( \$reflectionVector, "\$reflectionVector" );																								
			&ComputeReflectionVector( $worldPos, $worldNormal, $reflectionVector );																								
			push @output, "			; transform reflection vector into view space																								; LINEINFO(UnlitGeneric_inc.vsh)(72)\n";
			push @output, "			dp3 oT1.x, $reflectionVector, $cViewModel0																								; LINEINFO(UnlitGeneric_inc.vsh)(73)\n";
			push @output, "			dp3 oT1.y, $reflectionVector, $cViewModel1																								; LINEINFO(UnlitGeneric_inc.vsh)(74)\n";
			push @output, "			dp3 oT1.z, $reflectionVector, $cViewModel2																								; LINEINFO(UnlitGeneric_inc.vsh)(75)\n";
			&FreeRegister( \$reflectionVector, "\$reflectionVector" );																								
		}																								
		elsif( $envmapsphere )																								
		{																								
			&AllocateRegister( \$reflectionVector, "\$reflectionVector" );																								
		...
		push @output, "		; envmap mask																								; LINEINFO(UnlitGeneric_inc.vsh)(92)\n";
		push @output, "		dp4 oT2.x, $vTexCoord0, c92	; FIXME																								; LINEINFO(UnlitGeneric_inc.vsh)(93)\n";
		push @output, "		dp4 oT2.y, $vTexCoord0, c93 ; FIXME																								; LINEINFO(UnlitGeneric_inc.vsh)(94)\n";
		&FreeRegister( \$worldPos, "\$worldPos" );																								
		&FreeRegister( \$worldNormal, "\$worldNormal" );																								
	}																								
	if( $detail )																								
	{																								
		push @output, "		dp4 oT3.x, $vTexCoord0, c94		; FIXME																								; LINEINFO(UnlitGeneric_inc.vsh)(102)\n";
		push @output, "		dp4 oT3.y, $vTexCoord0, c95		; FIXME																								; LINEINFO(UnlitGeneric_inc.vsh)(103)\n";
	}																								
	if( $vertexcolor )																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(UnlitGeneric_inc.vsh)(108)\n";
		push @output, "		mul oD0, $vColor, $cModulationColor																								; LINEINFO(UnlitGeneric_inc.vsh)(109)\n";
	}																								
	else																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(UnlitGeneric_inc.vsh)(113)\n";
		push @output, "		mov oD0, $cModulationColor																								; LINEINFO(UnlitGeneric_inc.vsh)(114)\n";
	}																								
}																								
$detail = 0;																								
$envmap = 0;																								
