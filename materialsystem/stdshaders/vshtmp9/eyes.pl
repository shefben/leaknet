push @output, "vs.1.1																								; LINEINFO(eyes.vsh)(1)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(2)\n";
 	 push @output, ";	 c90	 = eyeball origin			FIXME																								; LINEINFO(eyes.vsh)(3)\n";
 	 push @output, ";	 c91	 = eyeball up * 0.5			FIXME																								; LINEINFO(eyes.vsh)(4)\n";
 	 push @output, ";	 c92	 = iris projection U		FIXME																								; LINEINFO(eyes.vsh)(5)\n";
 	 push @output, ";	 c93	 = iris projection V		FIXME																								; LINEINFO(eyes.vsh)(6)\n";
 	 push @output, ";	 c94	 = glint projection U		FIXME																								; LINEINFO(eyes.vsh)(7)\n";
 	 push @output, ";	 c95	 = glint projection V		FIXME																								; LINEINFO(eyes.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(9)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(13)\n";
push @output, "; Vertex blending (whacks r1-r7, positions in r7)																								; LINEINFO(eyes.vsh)(14)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(15)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&SkinPosition( $g_numBones, $worldPos );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(19)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(eyes.vsh)(20)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(21)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(eyes.vsh)(25)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(eyes.vsh)(26)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(eyes.vsh)(27)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(eyes.vsh)(28)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(eyes.vsh)(29)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(31)\n";
push @output, "; Normal is based on vertex position 																								; LINEINFO(eyes.vsh)(32)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(33)\n";
&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
&AllocateRegister( \$normalDotUp, "\$normalDotUp" );																								
push @output, "sub $worldNormal, $worldPos, c90		; Normal = (Pos - Eye origin)																								; LINEINFO(eyes.vsh)(37)\n";
push @output, "dp3 $normalDotUp, $worldNormal, c91		; Normal -= 0.5f * (Normal dot Eye Up) * Eye Up																								; LINEINFO(eyes.vsh)(38)\n";
push @output, "mul $normalDotUp, $normalDotUp, c0.w																								; LINEINFO(eyes.vsh)(39)\n";
push @output, "mad $worldNormal, -$normalDotUp, c91, $worldNormal																								; LINEINFO(eyes.vsh)(40)\n";
&FreeRegister( \$normalDotUp, "\$normalDotUp" );																								
push @output, "; normalize the normal																								; LINEINFO(eyes.vsh)(44)\n";
&Normalize( $worldNormal );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(47)\n";
push @output, "; Lighting																								; LINEINFO(eyes.vsh)(48)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(49)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(55)\n";
push @output, "; Fog																								; LINEINFO(eyes.vsh)(56)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(57)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(63)\n";
push @output, "; Texture coordinates																								; LINEINFO(eyes.vsh)(64)\n";
push @output, "; Texture 0 is the base texture																								; LINEINFO(eyes.vsh)(65)\n";
push @output, "; Texture 1 is a planar projection used for the iris																								; LINEINFO(eyes.vsh)(66)\n";
push @output, "; Texture 2 is a planar projection used for the glint																								; LINEINFO(eyes.vsh)(67)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes.vsh)(68)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(eyes.vsh)(70)\n";
push @output, "dp4 oT1.x, c92, $worldPos		; FIXME																								; LINEINFO(eyes.vsh)(71)\n";
push @output, "dp4 oT1.y, c93, $worldPos		; FIXME																								; LINEINFO(eyes.vsh)(72)\n";
push @output, "dp4 oT2.x, c94, $worldPos		; FIXME																								; LINEINFO(eyes.vsh)(73)\n";
push @output, "dp4 oT2.y, c95, $worldPos		; FIXME																								; LINEINFO(eyes.vsh)(74)\n";
