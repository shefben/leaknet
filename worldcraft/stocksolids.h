...
class StockSolid
{
	public:
		...
		// dvs: CreateMapSolid should maybe take a texture alignment parameter so it doesn't need to know about Options
		virtual void CreateMapSolid(CMapSolid *pSolid) = 0;
...
class StockBlock : public StockSolid
{
	public:
		...
		void CreateMapSolid(CMapSolid *pSolid);
