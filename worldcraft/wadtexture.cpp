...
//			dwFlags - 
//-----------------------------------------------------------------------------
void CWADTexture::DrawNoImage(CDC *pDC, RECT& rect, int iFontHeight, DWORD dwFlags)
{
	// draw "no data"
...
//			dwFlags - 
//-----------------------------------------------------------------------------
void CWADTexture::Draw(CDC *pDC, RECT& rect, int iFontHeight, int iIconHeight, DWORD dwFlags)
{
	if (!m_nWidth)
	{
		DrawNoImage(pDC, rect, iFontHeight, dwFlags);
		return;
	}
