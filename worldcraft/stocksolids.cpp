...
void StockBlock::CreateMapSolid(CMapSolid *pSolid)
{
	CMapFace Face;
...
void StockWedge::CreateMapSolid(CMapSolid *pSolid)
{
	CMapFace Face;
...
void StockCylinder::CreateMapSolid(CMapSolid *pSolid)
{
	CMapFace Face;
...
void StockSpike::CreateMapSolid(CMapSolid *pSolid)
{
	float fDepth = float(GetFieldData(fieldDepth))/2;
	float fWidth = float(GetFieldData(fieldWidth))/2;
	float fHeight = float(GetFieldData(fieldHeight))/2;
...
//-----------------------------------------------------------------------------
void StockSphere::CreateMapSolid(CMapSolid *pSolid)
{
	CMapFace Face;
