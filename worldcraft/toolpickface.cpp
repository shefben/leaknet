...
//-----------------------------------------------------------------------------
void CToolPickFace::OnDeactivate(ToolID_t eNewTool)
{
	DeselectAll();
}
...
//-----------------------------------------------------------------------------
bool CToolPickFace::OnLMouseUp3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnLMouseDblClk3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnRMouseUp3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnRMouseDown3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnMouseMove3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	SetEyedropperCursor();
	return true;
}
