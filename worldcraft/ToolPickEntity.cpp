...
//-----------------------------------------------------------------------------
void CToolPickEntity::OnDeactivate(ToolID_t eNewTool)
{
	DeselectAll();
}
...
//-----------------------------------------------------------------------------
bool CToolPickEntity::OnLMouseUp3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickEntity::OnLMouseDown3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	bool bControl = ((nFlags & MK_CONTROL) != 0);

	unsigned long uEntity;
	CMapClass *pObject = pView->NearestObjectAt(point, uEntity);
	if (pObject != NULL)
	{
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickEntity::OnLMouseDblClk3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickEntity::OnRMouseUp3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickEntity::OnRMouseDown3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickEntity::OnMouseMove3D(CMapView3D *pView, UINT nFlags, CPoint point)
{
	SetEyedropperCursor();
	return true;
}
