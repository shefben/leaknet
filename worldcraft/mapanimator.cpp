...
//-----------------------------------------------------------------------------
bool CMapAnimator::GetTransformMatrix( matrix4_t& matrix )
{
	// are we currently animating?
	if ( m_bCurrentlyAnimating )
	{
		memcpy( matrix.Base(), m_CoordFrame.Base(), sizeof(m_CoordFrame) );
		return true;
	}
...
// Input  : pClone - 
//-----------------------------------------------------------------------------
void CMapAnimator::OnClone( CMapClass *pClone, CMapWorld *pWorld, CMapObjectList &OriginalList, CMapObjectList &NewList )
{
