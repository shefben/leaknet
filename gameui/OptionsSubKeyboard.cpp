...
static const char *UTIL_Parse( const char *data )
{
	data = engine->COM_ParseFile( data, token );
	return data;
}
static const char *UTIL_GetToken( void )
{
	return token;
}
static const char *UTIL_CopyString( char const *in )
{
...
const char *UTIL_va(const char *format, ...)
{
	va_list         argptr;
