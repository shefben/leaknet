...
public:
	...
	virtual int	DrawColoredText( vgui::HFont font, int x, int y, int r, int g, int b, int a, const char *fmt, ... );
	virtual void DrawColoredTextRect( vgui::HFont font, int x, int y, int w, int h, int r, int g, int b, int a, const char *fmt, ... );
	virtual void DrawTextHeight( vgui::HFont font, int w, int& h, const char *fmt, ... );
...
private:
	...
	void SearchForWordBreak( vgui::HFont font, const char *text, int& chars, int& pixels );
