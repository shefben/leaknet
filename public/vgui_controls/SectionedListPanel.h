...
public:
	...
	virtual void SetSectionAlwaysVisible(int sectionID);
	...
	virtual int AddItem(int sectionID, KeyValues *data);

	// modifies an existing item; returns false if the item does not exist
	virtual bool ModifyItem(int itemID, int sectionID, KeyValues *data);
