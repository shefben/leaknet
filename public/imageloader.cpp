...
void 
#endif // _LINUX
	ConvertIA88ImageToNormalMapRGBA8888( unsigned char *src, int width, 
...
void 
#endif
	ConvertNormalMapRGBA8888ToDUDVMapUVWQ8888( unsigned char *src, int width, int height,
										                     unsigned char *dst_ )
{
...
void 
#endif
	ConvertNormalMapRGBA8888ToDUDVMapUV88( unsigned char *src, int width, int height,
										                     unsigned char *dst_ )
{
	unsigned char *lastPixel = src + width * height * 4;
	char *dst = ( char * )dst_; // NOTE: this is signed!!!!
...
void 
#endif
	NormalizeNormalMapRGBA8888( unsigned char *src, int numTexels )
{
	unsigned char *pixel;
