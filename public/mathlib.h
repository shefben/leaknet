...
#elif defined( _LINUX )
	return fmax( v[0], fmax( v[1], v[2] ) ); // VXP: Ugly 
#endif // _LINUX
}
...
#elif defined( _LINUX )
	return fmax( v.x, fmax( v.y, v.z ) ); // VXP: But anyway
#endif // _LINUX
}
...
// These globals are initialized in GL_RMISC.C: R_SSE(), R_MMX()
...
// Init the mathlib
void MathLib_Init( float gamma, float texGamma, float brightness, int overbright, bool bAllowSSE = true, bool bAllowSSE2 = true, bool bAllowMMX = true );
