...
//-----------------------------------------------------------------------------
// tyabus: 016 - Added IsModelPrecached,IsDecalPrecached,IsGenericPrecached
#define INTERFACEVERSION_VENGINESERVER	"VEngineServer016"
...
public:
	...
	virtual const char		*GetInfoKeyBuffer( edict_t *e ) = 0;	// passing in NULL gets the serverinfo
	virtual const char		*InfoKeyValue( const char *infobuffer, const char *key ) = 0;
	virtual void		SetClientKeyValue( int clientIndex, const char *infobuffer, const char *key, const char *value ) = 0;
	virtual const char		*COM_ParseFile( const char *data, char *token ) = 0;
