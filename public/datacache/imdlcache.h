...
abstract_class IMDLCache : public IBaseInterface
{
public:
	...
	// Async loading - this will call the QueuedLoader
	virtual bool GetAsyncLoading() = 0;
	virtual void SetAsyncLoading( bool bAsync ) = 0;
