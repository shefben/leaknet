...
#define	FCVAR_SERVER			(1<<8)	// notifies players when changed
...
public:
	...
	char const					*GetHelpText( void ) const;
...
FORCEINLINE char const *ConVar::GetString( void ) const 
{
	...
	ConVar *var = ( ConVar * )m_pParent;
	return ( var->m_pszString ) ? var->m_pszString : "";
}
