...
SampleListPanelBoth::SampleListPanelBoth(Panel *parent, const char *name) : DemoPage(parent, name)
{
	...
	m_pSectionedListPanel->AddColumnToSection(0, "items", "First column", SectionedListPanel::COLUMN_BRIGHT, 200);
	...
	m_pSectionedListPanel->AddColumnToSection(0, "items", "Second column", SectionedListPanel::COLUMN_BRIGHT, 200);
	...
	m_pSectionedListPanel->AddColumnToSection(2, "items", "Third column", SectionedListPanel::COLUMN_BRIGHT, 200);
