...
set( PHONEMEEXTRACTOR_SOURCE_FILES )
BEGIN_SRC( PHONEMEEXTRACTOR_SOURCE_FILES "Source Files" )
	SRC_GRP(
		SOURCES
		#{
...
END_SRC( PHONEMEEXTRACTOR_SOURCE_FILES "Source Files" )

set( PHONEMEEXTRACTOR_HEADER_FILES )
BEGIN_SRC( PHONEMEEXTRACTOR_HEADER_FILES "Header Files" )
	SRC_GRP(
		SOURCES
		#{
...
END_SRC( PHONEMEEXTRACTOR_HEADER_FILES "Header Files" )

add_object(
	TARGET phonemeextractor
	MODULE
	PROPERTY_FOLDER "Utils//Shared Libs"
	INSTALL_DEST "${GAMEDIR}/bin/phonemeextractors"
	SOURCES ${PHONEMEEXTRACTOR_SOURCE_FILES} ${PHONEMEEXTRACTOR_HEADER_FILES}
)

target_include_directories(
	phonemeextractor PRIVATE
