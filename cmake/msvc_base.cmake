...
add_compile_definitions(
	MSVC
	COMPILER_MSVC
	$<$<NOT:${IS_64BIT}>:COMPILER_MSVC32> # MSVC32
	$<${IS_64BIT}:COMPILER_MSVC64> # MSVC64
...
set(
	...
	/Gw
	#/Zc:threadSafeInit-	# Windows XP dead workaround
	/Zc:__cplusplus	# MSVC2019
	/Zc:preprocessor	# MSVC2019
	/Zc:inline
	...
	$<$<NOT:${IS_64BIT}>:/arch:SSE2> # Enable SSE2
