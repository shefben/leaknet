...
int CBasePanel::DrawColoredText( vgui::HFont font, int x, int y, int r, int g, int b, int a, const char *fmt, va_list argptr )
{
	static int count = 0;
...
int CBasePanel::DrawColoredText( vgui::HFont font, int x, int y, int r, int g, int b, int a, const char *fmt, ... )
{
	va_list argptr;
	va_start( argptr, fmt );
...
// Output : 
//-----------------------------------------------------------------------------
int	CBasePanel::DrawTextLen( vgui::HFont font, const char *fmt, ... )
{
	va_list argptr;
	char data[ 1024 ];
	int len;
