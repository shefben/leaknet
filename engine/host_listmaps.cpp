...
void Host_Map_Background_f( void );
...
// Output : int
//-----------------------------------------------------------------------------
static int Host_Map_Background_f_CompletionFunc( char const *partial, char commands[COMMAND_COMPLETION_MAXITEMS][COMMAND_COMPLETION_ITEM_LENGTH] )
{
...
static ConCommand changelevel( "changelevel", Host_Changelevel_f, "Continue game on a new level.", 0, Host_Changelevel_f_CompletionFunc );
static ConCommand changelevel2( "changelevel2", Host_Changelevel2_f, "Continue game on a new level in the unit.", 0, Host_Changelevel2_f_CompletionFunc );
static ConCommand map_background( "map_background", Host_Map_Background_f, "Runs a map as the background to the main menu.", 0, Host_Map_Background_f_CompletionFunc );
#endif
