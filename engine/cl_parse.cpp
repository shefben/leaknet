...
qboolean CL_CheckCRCs( const char *pszMap )
{
	...
	ContinueLoadingProgressBar( "ClientConnect", 4, 0.f );
...
{
	ContinueLoadingProgressBar( "ClientConnect", 8, 0.f );
...
void CL_ParseServerInfo (void)
{
	...
	ContinueLoadingProgressBar( "ClientConnect", 3, 0.f );
	...
	if( cl.maxclients > 1 )
	{
		...
		VGuiWrap2_LoadingStarted( "level", lvl );
	}
	...
	// TODO: There's no "sendres" message anymore
	//SetSecondaryProgressBar( 100.f );
}
