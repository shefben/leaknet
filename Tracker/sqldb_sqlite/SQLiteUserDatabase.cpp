...
//-----------------------------------------------------------------------------
// Purpose: SQLite interface to database
//-----------------------------------------------------------------------------
class CSQLiteUserDatabase : public ITrackerUserDatabase
{
public:
	CSQLiteUserDatabase();
...
EXPOSE_INTERFACE(CSQLiteUserDatabase, ITrackerUserDatabase, TRACKERUSERDATABASE_INTERFACE_VERSION);

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSQLiteUserDatabase::CSQLiteUserDatabase()
{
}
...
//-----------------------------------------------------------------------------
bool CSQLiteUserDatabase::Initialize(unsigned int serverID, const char *serverName, const char *catalogName)
{
...
//-----------------------------------------------------------------------------
bool CSQLiteUserDatabase::RunFrame()
{
...
// Output : int
//-----------------------------------------------------------------------------
int CSQLiteUserDatabase::QueriesInOutQueue()
{
...
// Output : int
//-----------------------------------------------------------------------------
int CSQLiteUserDatabase::QueriesInFinishedQueue()
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::deleteThis()
{
	delete this;
}
...
public:
	...
	virtual int RunCommand(sqlite3 *connection)
	{
		int rc;
		int ret;
		char* zErrMsg = 0;
		...
		sprintf(query, "select userID from User where emailAddress = %s", m_szEmail);
		rc = sqlite3_exec(connection, query, callback, 0, &zErrMsg);
		if (rc)
		{
		...
		sprintf(query, "insert into User ( userId, firstName, lastName, nickName, password, emailAddress ) values ( "
			"%d, \"%s\", \"%s\", \"%s\", \"%s\", \"%s\" )", m_iUserID, m_szFirstName, m_szLastName, m_szUserName, m_szPassword, m_szEmail);

		rc = sqlite3_exec(connection, query, [m_iUserID = m_iUserID](void* NotUsed, int argc, char** argv, char** azColName) -> int
			{
				return atoi(argv[0]);
			}, 0, &zErrMsg);
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_Login(ISQLDBReplyTarget *replyTarget, unsigned int userID, const char *password, unsigned int userIP, unsigned short userPort, unsigned int sessionID, int status, int build)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_Validate(ISQLDBReplyTarget *replyTarget, const char *email, const char *password, unsigned int IP, unsigned int port, unsigned int temporaryID)
{
...
// Purpose: Logs the user off the server
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_Logoff(ISQLDBReplyTarget *replyTarget, unsigned int userID, bool forceLogoff)
{
	// create the command and add it to the execute queue
...
// Purpose: 
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetSessionInfo(ISQLDBReplyTarget *replyTarget, int returnState, unsigned int userID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_Create(ISQLDBReplyTarget *replyTarget, unsigned int userID, const char *email, const char *password, const char *userName, const char *firstName, const char *lastName, unsigned int IP, unsigned int port )
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_Update( unsigned int userID, int newStatus, unsigned int gameIP, unsigned int gamePort, const char *gameType )
{
	// fill in command
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Find_Users(ISQLDBReplyTarget *replyTarget, unsigned int userID, const char *email, const char *userName, const char *firstName, const char *lastName)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetFriendList(ISQLDBReplyTarget *replyTarget, unsigned int userID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_SetAuth(unsigned int userID, unsigned int targetID, int authLevel)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_RemoveAuth(unsigned int userID, unsigned int targetID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_SetBlock(unsigned int userID, unsigned int blockedID, bool block)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_SetInfo(unsigned int userID, const char *userName, const char *firstName, const char *lastName)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_PostMessage(unsigned int fromUID, unsigned int toUID, const char *messageType, const char *body, const char *fromName, int flags)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_IsAuthed(ISQLDBReplyTarget *replyTarget, int returnState, unsigned int userID, int targetID, const char *extraData)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetInfo(ISQLDBReplyTarget *replyTarget, int returnState, unsigned int userID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetWatchers(ISQLDBReplyTarget *replyTarget, unsigned int userID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetMessage(ISQLDBReplyTarget *replyTarget, unsigned int userID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_DeleteMessage(ISQLDBReplyTarget *replyTarget, unsigned int userID, int iMsgID)
{
...
// Purpose: returns the number of users in the range still online
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Users_AreOnline(ISQLDBReplyTarget *replyTarget, unsigned int lowerUserIDRange, unsigned int upperUserIDRange)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Users_GetCompleteUserData(ISQLDBReplyTarget *replyTarget, unsigned int lowerUserIDRange, unsigned int upperUserIDRange, completedata_t *data)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Users_InsertCompleteUserData(ISQLDBReplyTarget *replyTarget, unsigned int lowerUserIDRange, unsigned int upperUserIDRange, const completedata_t *data)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Users_DeleteRange(unsigned int lowerUserIDRange, unsigned int upperUserIDRange)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_AddWatcher(unsigned int userID, unsigned int sessionID, unsigned int serverID, simpleuser_t *friends, int friendCount)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_AddSingleWatch(unsigned int userID, unsigned int sessionID, unsigned int serverID, unsigned int friendID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_RemoveWatcher(unsigned int userID)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetFriendsStatus(ISQLDBReplyTarget *replyTarget, unsigned int userID, simpleuser_t *friends, int friendCount)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::User_GetFriendsGameStatus(ISQLDBReplyTarget *replyTarget, unsigned int userID, simpleuser_t *friends, int friendCount)
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Users_KillAllUsersFromServer()
{
...
//-----------------------------------------------------------------------------
void CSQLiteUserDatabase::Users_Flush()
{
