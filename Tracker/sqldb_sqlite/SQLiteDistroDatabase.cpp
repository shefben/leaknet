...
//-----------------------------------------------------------------------------
class CSQLiteDistroDatabase : public ITrackerDistroDatabase
{
public:
	CSQLiteDistroDatabase() {}
...
EXPOSE_INTERFACE(CSQLiteDistroDatabase, ITrackerDistroDatabase, TRACKERDISTRODATABASE_INTERFACE_VERSION);

//-----------------------------------------------------------------------------
// Purpose: sets up the database
//-----------------------------------------------------------------------------
bool CSQLiteDistroDatabase::Initialize(int serverID, const char *serverName, const char *catalogName, CreateInterfaceFn debugFactory)
{
...
//-----------------------------------------------------------------------------
bool CSQLiteDistroDatabase::RunFrame()
{
...
// Purpose: Cleanup
//-----------------------------------------------------------------------------
void CSQLiteDistroDatabase::deleteThis()
{
	delete this;
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CSQLiteDistroDatabase::GetUserDistribution(CUtlVector<trackerserver_t> &serverList)
{
...
//-----------------------------------------------------------------------------
void CSQLiteDistroDatabase::UpdateUserDistribution(ISQLDBReplyTarget *replyTarget, const char *srcServer, const char *srcCatalog, const char *destServer, const char *destCatalog, int lowerRange, int upperRange)
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
void CSQLiteDistroDatabase::ReserveUserID(ISQLDBReplyTarget *replyTarget, const char *email, const char *password, const char *userName, const char *firstName, const char *lastName, int IP, int port)
{
