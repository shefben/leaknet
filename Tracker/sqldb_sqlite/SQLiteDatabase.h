...
//-----------------------------------------------------------------------------
// Purpose: Generic SQLite accessing database
//			Provides threaded I/O queue functionality for accessing a sqlite db
//-----------------------------------------------------------------------------
...
public:
	...
	sqlite::database &DB() { return m_Connection; }
...
public:
	...
	virtual int RunCommand(sqlite3 &connection) = 0;
