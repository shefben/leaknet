...
CDialogAbout::CDialogAbout() : Frame(NULL, "DialogAbout")
{
	...
	LoadControlSettings("Friends/DialogAbout.res", "PLATFORM");
...
void CDialogAbout::PerformLayout()
{
	...
	if (!system()->GetRegistryString("HKEY_CURRENT_USER\\Software\\LeakNet\\Tracker\\Version", versionString, sizeof(versionString)))
	{
