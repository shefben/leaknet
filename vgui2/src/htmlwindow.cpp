...
static int staticKeyTrans[256];
static bool staticKeyInit=false;
...
{
public:
	FS_IDispatch(FrameSite* fs) { m_fs = fs; m_bNewURL=0; m_bOnLink=false;}
	~FS_IDispatch() {}
...
//-----------------------------------------------------------------------------
// Purpose: a mapping from vgui::KeyCode to win32 messages
//-----------------------------------------------------------------------------
void InitStaticKeys()
{

	 	//sure this probably should go in another file and just be included here, but hey I'll
	//just leave it here anyway
	staticKeyTrans[vgui::KEY_0]='0';
	staticKeyTrans[vgui::KEY_1]='1';
	staticKeyTrans[vgui::KEY_2]='2';
	staticKeyTrans[vgui::KEY_3]='3';
	staticKeyTrans[vgui::KEY_4]='4';
	staticKeyTrans[vgui::KEY_5]='5';
	staticKeyTrans[vgui::KEY_6]='6';
	staticKeyTrans[vgui::KEY_7]='7';
	staticKeyTrans[vgui::KEY_8]='8';
	staticKeyTrans[vgui::KEY_9]='9';
	staticKeyTrans[vgui::KEY_A]='A';
	staticKeyTrans[vgui::KEY_B]='B';
	staticKeyTrans[vgui::KEY_C]='C';
	staticKeyTrans[vgui::KEY_D]='D';
	staticKeyTrans[vgui::KEY_E]='E';
	staticKeyTrans[vgui::KEY_F]='F';
	staticKeyTrans[vgui::KEY_G]='G';
	staticKeyTrans[vgui::KEY_H]='H';
	staticKeyTrans[vgui::KEY_I]='I';
	staticKeyTrans[vgui::KEY_J]='J';
	staticKeyTrans[vgui::KEY_K]='K';
	staticKeyTrans[vgui::KEY_L]='L';
	staticKeyTrans[vgui::KEY_M]='M';
	staticKeyTrans[vgui::KEY_N]='N';
	staticKeyTrans[vgui::KEY_O]='O';
	staticKeyTrans[vgui::KEY_P]='P';
	staticKeyTrans[vgui::KEY_Q]='Q';
	staticKeyTrans[vgui::KEY_R]='R';
	staticKeyTrans[vgui::KEY_S]='S';
	staticKeyTrans[vgui::KEY_T]='T';
	staticKeyTrans[vgui::KEY_U]='U';
	staticKeyTrans[vgui::KEY_V]='V';
	staticKeyTrans[vgui::KEY_W]='W';
	staticKeyTrans[vgui::KEY_X]='X';
	staticKeyTrans[vgui::KEY_Y]='Y';
	staticKeyTrans[vgui::KEY_Z]='Z';
	staticKeyTrans[vgui::KEY_PAD_0]=VK_NUMPAD0;
	staticKeyTrans[vgui::KEY_PAD_1]=VK_NUMPAD1;
	staticKeyTrans[vgui::KEY_PAD_2]=VK_NUMPAD2;
	staticKeyTrans[vgui::KEY_PAD_3]=VK_NUMPAD3;
	staticKeyTrans[vgui::KEY_PAD_4]=VK_NUMPAD4;
	staticKeyTrans[vgui::KEY_PAD_5]=VK_NUMPAD5;
	staticKeyTrans[vgui::KEY_PAD_6]=VK_NUMPAD6;
	staticKeyTrans[vgui::KEY_PAD_7]=VK_NUMPAD7;
	staticKeyTrans[vgui::KEY_PAD_8]=VK_NUMPAD8;
	staticKeyTrans[vgui::KEY_PAD_9]=VK_NUMPAD9;
	staticKeyTrans[vgui::KEY_PAD_DIVIDE] =VK_DIVIDE;
	staticKeyTrans[vgui::KEY_PAD_MULTIPLY]=VK_MULTIPLY;
	staticKeyTrans[vgui::KEY_PAD_MINUS]=VK_SUBTRACT;
	staticKeyTrans[vgui::KEY_PAD_PLUS]=VK_ADD;
	staticKeyTrans[vgui::KEY_PAD_ENTER]=0xd;
	staticKeyTrans[vgui::KEY_PAD_DECIMAL] =VK_DECIMAL;

	staticKeyTrans[vgui::KEY_LBRACKET] =0xdb;
	staticKeyTrans[vgui::KEY_RBRACKET] =0xdd;
	staticKeyTrans[vgui::KEY_SEMICOLON] =0xba;
	staticKeyTrans[vgui::KEY_APOSTROPHE] =0xde;
	staticKeyTrans[vgui::KEY_BACKQUOTE] =0xc0;
	staticKeyTrans[vgui::KEY_COMMA] = 0xbc;
	staticKeyTrans[vgui::KEY_PERIOD] =0xbe;
	staticKeyTrans[vgui::KEY_SLASH] =0xbf;
	staticKeyTrans[vgui::KEY_BACKSLASH] =0xdc;
	staticKeyTrans[vgui::KEY_MINUS] =0xbd;
	staticKeyTrans[vgui::KEY_EQUAL] =0xbb;
	staticKeyTrans[vgui::KEY_ENTER] =VK_RETURN;
	staticKeyTrans[vgui::KEY_SPACE] =VK_SPACE;
	staticKeyTrans[vgui::KEY_BACKSPACE] =VK_BACK;
	staticKeyTrans[vgui::KEY_TAB] =VK_TAB;
	staticKeyTrans[vgui::KEY_CAPSLOCK] =0x14;
	staticKeyTrans[vgui::KEY_NUMLOCK] =0x90;
	staticKeyTrans[vgui::KEY_ESCAPE] =VK_ESCAPE;
	staticKeyTrans[vgui::KEY_SCROLLLOCK] =VK_SCROLL;
	staticKeyTrans[vgui::KEY_INSERT] =VK_INSERT;
	staticKeyTrans[vgui::KEY_DELETE] = VK_DELETE;
	staticKeyTrans[vgui::KEY_HOME] =VK_HOME;
	staticKeyTrans[vgui::KEY_END] =VK_END;
	staticKeyTrans[vgui::KEY_PAGEUP] =VK_PRIOR;
	staticKeyTrans[vgui::KEY_PAGEDOWN] =VK_NEXT;
	staticKeyTrans[vgui::KEY_BREAK] =0x13;
	staticKeyTrans[vgui::KEY_LSHIFT] =0x10;
	staticKeyTrans[vgui::KEY_RSHIFT] =0x10;
	staticKeyTrans[vgui::KEY_LALT] =0x12;
	staticKeyTrans[vgui::KEY_RALT] =0x12;
	staticKeyTrans[vgui::KEY_LCONTROL] =0x11;
	staticKeyTrans[vgui::KEY_RCONTROL] =0x11;
	staticKeyTrans[vgui::KEY_LWIN] =VK_LWIN;
	staticKeyTrans[vgui::KEY_RWIN] = VK_RWIN;
	staticKeyTrans[vgui::KEY_APP] =VK_APPS;
	staticKeyTrans[vgui::KEY_UP] = VK_UP;
	staticKeyTrans[vgui::KEY_LEFT] = VK_LEFT;
	staticKeyTrans[vgui::KEY_DOWN] = VK_DOWN;
	staticKeyTrans[vgui::KEY_RIGHT] = VK_RIGHT;	

	staticKeyTrans[vgui::KEY_F1]=VK_F1;
	staticKeyTrans[vgui::KEY_F2]=VK_F2;
	staticKeyTrans[vgui::KEY_F3]=VK_F3;
	staticKeyTrans[vgui::KEY_F4]=VK_F4;
	staticKeyTrans[vgui::KEY_F5]=VK_F5;
	staticKeyTrans[vgui::KEY_F6]=VK_F6;
	staticKeyTrans[vgui::KEY_F7]=VK_F7;
	staticKeyTrans[vgui::KEY_F8]=VK_F8;
	staticKeyTrans[vgui::KEY_F9]=VK_F9;
	staticKeyTrans[vgui::KEY_F10]=VK_F10;
	staticKeyTrans[vgui::KEY_F11]=VK_F11;
	staticKeyTrans[vgui::KEY_F12]=VK_F12;

}

LRESULT CALLBACK WindowProc( HWND hwnd, UINT uMsg, WPARAM wParam,  LPARAM lParam  ); // defined right below the constructor
...
//		static int count;
	...
	// if its not one of our windows it must be the parent (hidden) one.
	if(win==NULL && msg->message==WM_TIMER)
	{

		for(int i=0;i<html_windows.Count();i++)
		{
			// "kick start" the child windows to get them to emit WM_TIMER events.
			//  This message came from the global parent "Internet Explorer_Hidden"
			if (::PostMessage(html_windows[i]->GetIEHWND(), WM_MOUSEMOVE, 0,html_windows[i]->GetMousePos())==0) 
			{ 
	...
	{		
		...
		{
		case WM_TIMER:
			//_snprintf(dbtxt,200,"$$$$$$$$$$$$$$$ Got msg to window! %x (%i,%p,%p)\n",msg->message,count++,msg->hwnd,win);
...
BOOL CALLBACK EnumChildProc( HWND hwnd,  LPARAM lParam )
{
	...
	for(int i=0;i<html_windows.Count();i++)
	{
		//HWND tst = html_windows[i]->GetIEParent();
		if(html_windows[i]->GetIEHWND()==parent)
		{
			win=html_windows[i];
			break;
		}
...
// Purpose: constructor
//-----------------------------------------------------------------------------
HtmlWindow::HtmlWindow(vgui::IHTMLEvents *events, vgui::VPANEL c,HWND parent)
{
	m_oleObject = NULL;
	...
	m_parent = CreateWindowEx(0,tmp,"", WS_CHILD| WS_DISABLED/*|  WS_POPUP | WS_CLIPSIBLINGS & ~WS_MAXIMIZEBOX*/,
							   0,0,1,1,parent,NULL,GetModuleHandle(NULL),NULL);

	//::ShowWindow(m_parent,SW_HIDE);

	if(staticKeyInit==false)
	{
		staticKeyInit=true;
		InitStaticKeys();
	}
...
/*	switch(uMsg)
	{
		case WM_TIMER:
			char dbtxt[200];
			_snprintf(dbtxt,200,"$$$$$$$$$$$$$$$ Got paint from window! %p\n",hwnd);
...
HtmlWindow::~HtmlWindow()
{
	...
	if(lasthDC)
	{
		...
		//::ReleaseDC(m_oleObjectHWND,hdcMem);
		::DeleteDC(hdcMem);
	}
	...
	// destroy the temp window we created for this object
...
//-----------------------------------------------------------------------------
// Purpose: determines whether the control is visible or not, NOT USED!!
//-----------------------------------------------------------------------------
...
void HtmlWindow::OnPaint(HDC hDC)
{
	...
	//TRACE_FUNCTION("HtmlWindow::OnPaint");

	if(w==0 || h==0)
		return; // have loaded a page yet
	...
	if (m_viewObject)
	{
		...
		m_viewObject->Draw(DVASPECT_CONTENT, -1, NULL, NULL, hDC, 
			hdcMem, prc, NULL, NULL, 0);

		LPBITMAPINFO lpbi = (LPBITMAPINFO)(new char[sizeof(BITMAPINFOHEADER) + 256 * sizeof(RGBQUAD)]);
	
		if(lpbi)
		{
			memset(lpbi,0x0,sizeof(BITMAPINFOHEADER));
			lpbi->bmiHeader.biSize = sizeof(BITMAPINFOHEADER); 
			// unselect the bitmap (not needed, even tho the doco says otherwise...)
			//SelectObject(hdcMem, oldbmp); 
			
			// query the bitmap for its constraints
			int chk=GetDIBits(hdcMem, hBitmap, 0L, (DWORD)h,
			...
			if(chk!=0)
			{
				...
				//	getbitsTime = system()->GetCurrentTime();

					if(chk!=0)
					{	
						unsigned char *bmpBits=static_cast<unsigned char *>(lpvBits);
						...
						if(!m_Bitmap)
						{
							...
							//delete m_Bitmap; // free the old image
						}
						else
						{
		...
		//::DeleteObject(bits);
		//::ReleaseDC(thisWindow,hdcMem);
		//::ReleaseDC(thisWindow,hdc);	
...
void HtmlWindow::OnMouse(vgui::MouseCode code,MOUSE_STATE s,int x,int y)
 {
	...
	// move the hidden IE container window to the top corner of the real panel
	::SetWindowPos(m_parent,HWND_TOP,pos_x,pos_y,w,h,SWP_HIDEWINDOW|SWP_NOACTIVATE);
	...
	// also tell it that it got focus
	if (m_ieHWND && ::PostMessage(m_ieHWND, WM_SETFOCUS, reinterpret_cast<uint>(m_parent), lParam)==0) 
	{ 
		//DWORD err= GetLastError();
		DEBUG("msg2 not delivered");
		return; 
...
//-----------------------------------------------------------------------------
void HtmlWindow::OnKeyDown(vgui::
						   KeyCode code)
{
	UINT msg = 0;
	WPARAM wParam = 1;
...
//-----------------------------------------------------------------------------
bool HtmlWindow::OnStartURL(const char * url,bool first)
{
	DEBUG("loading url:");
	DEBUG(url);
	...
	if(m_events)
	{
		if(m_events->OnStartURL(url,first))
		{
			return true;
		}
		else
...
// Purpose: returns whether the HTML element is a <a href></a> element
//-----------------------------------------------------------------------------
void HtmlWindow::SetHTMLSize(IHTMLElement *piElem)
{
...
void HtmlWindow::OnFinishURL(const char * url)
{
	...
	{	
		...
		if(pElement) SetHTMLSize(pElement);
		pElement->Release();
		pHTMLDocument2->Release();
	}
	pDisp->Release();
	...
	if(!hooked)
	{
		DWORD tid = ::GetWindowThreadProcessId(tst, NULL); 
...
//-----------------------------------------------------------------------------
// Purpose: triggers IE to load a new URL
//-----------------------------------------------------------------------------
...
//	OutputDebugString(dbtxt);
	...
	switch (dispIdMember)
	{
		case DISPID_BEFORENAVIGATE2:
		{
			...
			if(m_fs->m_window->OnStartURL((char*)_bstr_t(vurl->bstrVal),!m_bNewURL))
			{
		...
		case DISPID_DOWNLOADBEGIN:
		{
			// for each DOWNLOADBEGIN there is a DOWNLOADCOMPLETE
			m_bNewURL++;
			//vgui::ivgui()->DPrintf2("Begining download\n");
			break;
		}
