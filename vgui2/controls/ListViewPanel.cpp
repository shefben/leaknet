...
// Purpose: 
//-----------------------------------------------------------------------------
int ListViewPanel::AddItem(KeyValues *data, bool bScrollToItem, bool bSortOnAdd)
{
...
//-----------------------------------------------------------------------------
MessageMapItem_t ListViewPanel::m_MessageMap[] =
{
	MAP_MESSAGE( ListViewPanel, "ScrollBarSliderMoved", OnSliderMoved ),
};
IMPLEMENT_PANELMAP(ListViewPanel, BaseClass);
