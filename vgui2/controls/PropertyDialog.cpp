...
// Purpose: Message map
//-----------------------------------------------------------------------------
MessageMapItem_t PropertyDialog::m_MessageMap[] =
{
	MAP_MESSAGE( PropertyDialog, "ApplyButtonEnable", OnApplyButtonEnable),
};
IMPLEMENT_PANELMAP(PropertyDialog, BaseClass);
