...
const char *RichText::GetDescription()
{
	...
	Q_sprintf_safe(buf, "%s, string text", BaseClass::GetDescription());
	return buf;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
MessageMapItem_t RichText::m_MessageMap[] =
{
	MAP_MESSAGE( RichText, "ScrollBarSliderMoved", OnSliderMoved ),
	MAP_MESSAGE_INT( RichText, "ClickPanel", OnClickPanel, "index" ),
	MAP_MESSAGE_CONSTWCHARPTR( RichText, "SetText", OnSetText, "text" ),	// custom message
	// vgui messages
	MAP_MESSAGE( RichText, "DoCutSelected", CutSelected ),
	MAP_MESSAGE( RichText, "DoCopySelected", CopySelected ),
};

IMPLEMENT_PANELMAP(RichText, Panel);
