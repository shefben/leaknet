...
void WizardPanel::CreateButtons()
{
	...
	_prevButton->SetSize(72, 24);
	_nextButton->SetSize(72, 24);
	_cancelButton->SetSize(72, 24);
	_finishButton->SetSize(72, 24);
}
...
void WizardPanel::OnNextButton()
{
	if (_currentSubPanel)
	{
		...
		if (shouldAdvance)
		{
			WizardSubPanel *nextPanel = _currentSubPanel->GetNextSubPanel();
...
//-----------------------------------------------------------------------------
void WizardPanel::InternalOnCancelButton()
{
...
// Purpose: message handler
//-----------------------------------------------------------------------------
void WizardPanel::InternalOnFinishButton()
{
...
// Purpose: Message map
//-----------------------------------------------------------------------------
MessageMapItem_t WizardPanel::m_MessageMap[] =
{
	MAP_MESSAGE( WizardPanel, "NextButton", OnNextButton ),
	MAP_MESSAGE( WizardPanel, "PrevButton", OnPrevButton ),
	MAP_MESSAGE( WizardPanel, "CancelButton", InternalOnCancelButton ),
	MAP_MESSAGE( WizardPanel, "FinishButton", InternalOnFinishButton ),
	MAP_MESSAGE_PTR( WizardPanel, "ActivateNextSubPanel", ActivateNextSubPanel, "panel" ),
};
IMPLEMENT_PANELMAP(WizardPanel, Frame);
