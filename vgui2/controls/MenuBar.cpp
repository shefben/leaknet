...
// Purpose: Message map
//-----------------------------------------------------------------------------
void MenuBar::OnCursorEnteredMenuButton(VPANEL menuButton)
{
...
// Purpose: Message map
//-----------------------------------------------------------------------------
MessageMapItem_t MenuBar::m_MessageMap[] =
{
	MAP_MESSAGE( MenuBar, "MenuClose", OnMenuClose ),
	MAP_MESSAGE_INT( MenuBar, "CursorEnteredMenuButton", OnCursorEnteredMenuButton, "VPanel" ),
};
IMPLEMENT_PANELMAP(MenuBar, Button);