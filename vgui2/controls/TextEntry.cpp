...
const char *TextEntry::GetDescription()
{
	...
	Q_sprintf_safe(buf, "%s, bool textHidden, bool editable, bool NumericInputOnly", BaseClass::GetDescription());
	return buf;
}
