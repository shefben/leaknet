...
#include "../filesystem/filesystem_stdio/linux_support.h"
#endif
...
MessageMapItem_t FileCompletionEdit::m_MessageMap[] =
{
	MAP_MESSAGE_INT( FileCompletionEdit, "MenuItemHighlight", OnMenuItemHighlight, "itemID" ),
};
IMPLEMENT_PANELMAP(FileCompletionEdit, BaseClass)
...
FileOpenDialog::FileOpenDialog(Panel *parent, const char *title, bool bOpenOnly) : Frame(parent, "FileOpenDialog")
{
	...
	m_pFullPathEdit->SetTooltipFormatToSingleLine();
...
void FileOpenDialog::ValidatePath()
{
	...
	else
	{
		...
		Q_strncpy( pData, m_szLastPath, sizeof( pData ) );
	}
...
//-----------------------------------------------------------------------------
MessageMapItem_t FileOpenDialog::m_MessageMap[] =
{
	MAP_MESSAGE( FileOpenDialog, "ItemSelected", OnItemSelected ),
	MAP_MESSAGE( FileOpenDialog, "ListViewItemSelected", OnItemSelected), 
	MAP_MESSAGE_PARAMS( FileOpenDialog, "TextChanged", OnTextChanged ),
};
IMPLEMENT_PANELMAP( FileOpenDialog, BaseClass );
