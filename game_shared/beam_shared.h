...
{ 
	m_nBeamType = (m_nBeamType & 0xFF0) | (type&0x0F); 
}

inline void	CBeam::SetBeamFlags( int flags )	
{ 
	m_nBeamType = (m_nBeamType & 0x0F) | (flags&0xFF0); 
}

inline void	CBeam::SetBeamFlag( int flag )		
{ 
	m_nBeamType = (m_nBeamType & 0x0F) | ((m_nBeamType | flag)&0xFF0); 
}
...
inline int CBeam::GetType( void ) const 
{ 
	return m_nBeamType & 0x0F; 
}

inline int CBeam::GetBeamFlags( void ) const
{ 
	return m_nBeamType & 0xFF0; 
}
