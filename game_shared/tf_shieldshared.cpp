...
BEGIN_PREDICTION_DATA_NO_BASE( CShieldEffect )
	...
	DEFINE_FIELD( CShieldEffect, m_TestPoint, FIELD_INTEGER ),
	DEFINE_FIELD( CShieldEffect, m_Position, FIELD_VECTOR ),
	DEFINE_FIELD( CShieldEffect, m_Velocity, FIELD_VECTOR ),
	DEFINE_FIELD( CShieldEffect, m_CurrentAngles, FIELD_VECTOR ),
	DEFINE_FIELD( CShieldEffect, m_Theta, FIELD_FLOAT ),
	DEFINE_FIELD( CShieldEffect, m_Phi, FIELD_FLOAT ),
	DEFINE_FIELD( CShieldEffect, m_ThetaVelocity, FIELD_FLOAT ),
	DEFINE_FIELD( CShieldEffect, m_PhiVelocity, FIELD_FLOAT ),
	DEFINE_FIELD( CShieldEffect, m_vecDesiredOrigin, FIELD_VECTOR ),
	DEFINE_FIELD( CShieldEffect, m_angDesiredAngles, FIELD_VECTOR ),
	DEFINE_FIELD( CShieldEffect, m_ShieldTheta, FIELD_FLOAT ),
	DEFINE_FIELD( CShieldEffect, m_ShieldPhi, FIELD_FLOAT ),
...
void CShieldEffect::ComputeRestPositions()
{
	...
	Vector mins = Vector( -l * 0.25f, -l * 0.25f, -l * 0.25f);
	Vector maxs = Vector( l * 0.25f, l * 0.25f, l * 0.25f);
	SetShieldPanelSize( mins, maxs );
}
