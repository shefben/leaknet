...
BEGIN_DATADESC( CHarpoon )
	// Function Pointers
	DEFINE_FUNCTION( CHarpoon, HarpoonTouch ),
	DEFINE_FUNCTION( CHarpoon, FlyThink ),
	DEFINE_FUNCTION( CHarpoon, ConstrainThink ),
END_DATADESC()
...
BEGIN_PREDICTION_DATA( CWeaponHarpoon  )
	...
	DEFINE_PRED_FIELD_TOL( CWeaponHarpoon, m_flStartedThrowAt, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, TD_MSECTOLERANCE ),
