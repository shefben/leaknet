...
BEGIN_PREDICTION_DATA( CWeaponCombatPlasmaRifle  )
	...
	DEFINE_PRED_FIELD_TOL( CWeaponCombatPlasmaRifle, m_flPower, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, 0.05f ),
	DEFINE_PRED_FIELD( CWeaponCombatPlasmaRifle, m_bCharging, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
...
BEGIN_DATADESC( CWeaponCombatPlasmaRifle )
	...
	// Function Pointers
	DEFINE_FUNCTION( CWeaponCombatPlasmaRifle, ChargeThink ),
