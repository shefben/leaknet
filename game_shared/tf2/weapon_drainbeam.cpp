...
const char *g_pDrainingSound  = "weapons/repair_gun/healing.wav";
const char *g_pNoDrainTargetSound = "weapons/repair_gun/notarget.wav";
...
BEGIN_PREDICTION_DATA( CWeaponDrainBeam  )
	...
	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_bDraining, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_bAttacking, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD_TOL( CWeaponDrainBeam, m_vFireTarget, FIELD_VECTOR, FTYPEDESC_INSENDTABLE, 0.125f ),

	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_hDrainTarget, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),

//	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_pEmitter, FIELD_POINTER ),
//	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_hParticleMaterial, FIELD_???,  ),
//	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_PathParticleEvent, FIELD_???,  ),
//	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_DribbleParticleEvent, FIELD_??? ),
//	DEFINE_PRED_FIELD( CWeaponDrainBeam, m_bPlayingSound, FIELD_BOOLEAN ),
...
void CWeaponDrainBeam::StopDrainSound( bool bStopHealingSound, bool bStopNoTargetSound )
{
	if ( bStopHealingSound )
		StopSound( entindex(), CHAN_WEAPON, g_pDrainingSound );

	if ( bStopNoTargetSound )
		StopSound( entindex(), CHAN_WEAPON, g_pNoDrainTargetSound );
}
...
void CWeaponDrainBeam::ClientThink()
{
	...
	if ( !m_bPlayingSound )
	{
		...
		EmitSound( filter, entindex(), CHAN_WEAPON, g_pDrainingSound, 0.7, ATTN_NORM  );
	}
