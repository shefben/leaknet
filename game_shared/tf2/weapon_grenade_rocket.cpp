...
{
#if defined( CLIENT_DLL )
	StopSound( entindex(), CHAN_WEAPON, "weapons/rocket_flyloop1.wav" );
#endif
}
...
void CWeaponGrenadeRocket::Spawn( void )
{
	...
	filter.MakeReliable();
	EmitSound( filter, entindex(), CHAN_WEAPON, "weapons/rocket_flyloop1.wav", 1.0, ATTN_NORM );
#endif
}
...
void CWeaponGrenadeRocket::Precache( void )
{
	...
	enginesound->PrecacheSound( "weapons/rocket_flyloop1.wav" );
}
