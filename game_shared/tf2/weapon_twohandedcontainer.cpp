...
void CWeaponTwoHandedContainer::SetTransmit( CCheckTransmitInfo *pInfo )
{
	...
	if ( m_hLeftWeapon )
		m_hLeftWeapon->SetTransmit( pInfo );

	if ( m_hRightWeapon )
		m_hRightWeapon->SetTransmit( pInfo );
...
//-----------------------------------------------------------------------------
const char *CWeaponTwoHandedContainer::GetDeathNoticeName( void )
{
...
BEGIN_PREDICTION_DATA( CWeaponTwoHandedContainer  )
	...
	DEFINE_PRED_FIELD( CWeaponTwoHandedContainer, m_hRightWeapon, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CWeaponTwoHandedContainer, m_hLeftWeapon, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),
#if defined( CLIENT_DLL )
