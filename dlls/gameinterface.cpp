...
void CServerGameDLL::GameFrame( bool simulating )
{
	...
	// Execute Lua think functions
	// TODO: CLuaIntegration::DoThinkFunctions(); // Disabled until lua_integration.cpp is added to build
...
void CServerGameDLL::CreateNetworkStringTables( void )
{
	...
	g_VguiScreenStringOps.Init( g_StringTableVguiScreen );
}
