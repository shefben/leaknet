...
BEGIN_DATADESC( CLogicCompareInteger )
	...
	DEFINE_OUTPUT( CLogicCompareInteger, m_OnEqual, "OnEqual" ),
	DEFINE_OUTPUT( CLogicCompareInteger, m_OnNotEqual, "OnNotEqual" ),

	DEFINE_KEYFIELD( CLogicCompareInteger, m_iIntegerValue, FIELD_INTEGER, "IntegerValue" ),
	DEFINE_KEYFIELD( CLogicCompareInteger, m_iShouldCompareToValue, FIELD_INTEGER, "ShouldComparetoValue" ),

	DEFINE_FIELD( CLogicCompareInteger, m_AllIntCompares, FIELD_INPUT ),

	DEFINE_INPUTFUNC( CLogicCompareInteger, FIELD_INPUT, "InputValue", InputValue ),
	DEFINE_INPUTFUNC( CLogicCompareInteger, FIELD_INPUT, "CompareValues", InputCompareValues ),
...
BEGIN_DATADESC( CTimerEntity )
	...
	// Keys
	DEFINE_KEYFIELD( CTimerEntity, m_iDisabled, FIELD_INTEGER, "StartDisabled" ),
	DEFINE_KEYFIELD( CTimerEntity, m_flRefireTime, FIELD_FLOAT, "RefireTime" ),

	DEFINE_FIELD( CTimerEntity, m_bUpDownState, FIELD_BOOLEAN ),

	// Inputs
	DEFINE_INPUTFUNC( CTimerEntity, FIELD_FLOAT, "RefireTime", InputRefireTime ),
	DEFINE_INPUTFUNC( CTimerEntity, FIELD_VOID, "FireTimer", InputFireTimer ),
	DEFINE_INPUTFUNC( CTimerEntity, FIELD_VOID, "Enable", InputEnable ),
	DEFINE_INPUTFUNC( CTimerEntity, FIELD_VOID, "Disable", InputDisable ),
	DEFINE_INPUTFUNC( CTimerEntity, FIELD_VOID, "Toggle", InputToggle ),

	DEFINE_INPUT( CTimerEntity, m_iUseRandomTime, FIELD_INTEGER, "UseRandomTime" ),
	DEFINE_INPUT( CTimerEntity, m_flLowerRandomBound, FIELD_FLOAT, "LowerRandomBound" ),
	DEFINE_INPUT( CTimerEntity, m_flUpperRandomBound, FIELD_FLOAT, "UpperRandomBound" ),

	// Outputs
	DEFINE_OUTPUT( CTimerEntity, m_OnTimer, "OnTimer" ),
	DEFINE_OUTPUT( CTimerEntity, m_OnTimerHigh, "OnTimerHigh" ),
	DEFINE_OUTPUT( CTimerEntity, m_OnTimerLow, "OnTimerLow" ),
...
BEGIN_DATADESC( CLogicLineToEntity )
	...
	DEFINE_KEYFIELD( CLogicLineToEntity, m_SourceName, FIELD_STRING, "source" ),
 	DEFINE_FIELD( CLogicLineToEntity, m_StartEntity, FIELD_EHANDLE ),
	DEFINE_FIELD( CLogicLineToEntity, m_EndEntity, FIELD_EHANDLE ),

	// Outputs
	DEFINE_OUTPUT( CLogicLineToEntity, m_Line, "Line" ),
...
void CLogicLineToEntity::Activate(void)
{
	...
	if (m_target != NULL_STRING)
	{
		...
		//
		if ((m_EndEntity == NULL) || (m_EndEntity->pev == NULL))
		{
	...
	if (m_SourceName != NULL_STRING)
	{
		...
		// If we were given a bad measure target, just measure sound where we are.
		//
		if ((m_StartEntity == NULL) || (m_StartEntity->pev == NULL))
		{
...
void CLogicLineToEntity::Think(void)
{
	...
	if (!pDest || !pSrc || !pDest->pev || !pSrc->pev)
	{
...
BEGIN_DATADESC( CMathRemap )
	...
	DEFINE_INPUTFUNC(CMathRemap, FIELD_FLOAT, "InValue", InputValue ),

	DEFINE_OUTPUT(CMathRemap, m_OutValue, "OutValue"),

	DEFINE_KEYFIELD(CMathRemap, m_flInMin, FIELD_FLOAT, "in1"),
	DEFINE_KEYFIELD(CMathRemap, m_flInMax, FIELD_FLOAT, "in2"),
	DEFINE_KEYFIELD(CMathRemap, m_flOut1, FIELD_FLOAT, "out1"),
	DEFINE_KEYFIELD(CMathRemap, m_flOut2, FIELD_FLOAT, "out2"),
...
BEGIN_DATADESC( CMathColorBlend )
	...
	DEFINE_INPUTFUNC(CMathColorBlend, FIELD_FLOAT, "InValue", InputValue ),

	DEFINE_OUTPUT(CMathColorBlend, m_OutValue, "OutColor"),

	DEFINE_KEYFIELD(CMathColorBlend, m_flInMin, FIELD_FLOAT, "inmin"),
	DEFINE_KEYFIELD(CMathColorBlend, m_flInMax, FIELD_FLOAT, "inmax"),
	DEFINE_KEYFIELD(CMathColorBlend, m_OutColor1, FIELD_COLOR32, "colormin"),
	DEFINE_KEYFIELD(CMathColorBlend, m_OutColor2, FIELD_COLOR32, "colormax"),
...
BEGIN_DATADESC( CEnvGlobal )
	...
	DEFINE_KEYFIELD( CEnvGlobal, m_globalstate, FIELD_STRING, "globalstate" ),
	DEFINE_FIELD( CEnvGlobal, m_triggermode, FIELD_INTEGER ),
	DEFINE_KEYFIELD( CEnvGlobal, m_initialstate, FIELD_INTEGER, "initialstate" ),

	// Inputs
	DEFINE_INPUTFUNC( CEnvGlobal, FIELD_VOID, "TurnOn",	InputTurnOn ),
	DEFINE_INPUTFUNC( CEnvGlobal, FIELD_VOID, "TurnOff", InputTurnOff ),
	DEFINE_INPUTFUNC( CEnvGlobal, FIELD_VOID, "Remove",	InputRemove ),
	DEFINE_INPUTFUNC( CEnvGlobal, FIELD_VOID, "Toggle",	InputToggle ),
...
BEGIN_DATADESC( CMultiSource )
	...
	DEFINE_KEYFIELD( CMultiSource, m_globalstate, FIELD_STRING, "globalstate" ),

	// Function pointers
	DEFINE_FUNCTION( CMultiSource, Register ),

	// Outputs
	DEFINE_OUTPUT(CMultiSource, m_OnTrigger, "OnTrigger"),
...
{ 
	...
	if (i > m_iTotal)
	{
		Warning("MultiSrc: Used by non member %s.\n", pCaller->pev ? pCaller->GetClassname() : "<logical entity>");
		return;	
	}
...
BEGIN_DATADESC( CMathCounter )
	...
	DEFINE_FIELD(CMathCounter, m_bHitMax, FIELD_BOOLEAN),
	DEFINE_FIELD(CMathCounter, m_bHitMin, FIELD_BOOLEAN),

	// Keys
	DEFINE_KEYFIELD(CMathCounter, m_flMin, FIELD_FLOAT, "min"),
	DEFINE_KEYFIELD(CMathCounter, m_flMax, FIELD_FLOAT, "max"),

	// Inputs
	DEFINE_INPUTFUNC(CMathCounter, FIELD_FLOAT, "Add", InputAdd),
	DEFINE_INPUTFUNC(CMathCounter, FIELD_FLOAT, "Divide", InputDivide),
	DEFINE_INPUTFUNC(CMathCounter, FIELD_FLOAT, "Multiply", InputMultiply),
	DEFINE_INPUTFUNC(CMathCounter, FIELD_FLOAT, "SetValue", InputSetValue),
	DEFINE_INPUTFUNC(CMathCounter, FIELD_FLOAT, "Subtract", InputSubtract),

	// Outputs
	DEFINE_OUTPUT(CMathCounter, m_OutValue, "OutValue"),
	DEFINE_OUTPUT(CMathCounter, m_OnHitMin, "OnHitMin"),
	DEFINE_OUTPUT(CMathCounter, m_OnHitMax, "OnHitMax"),
...
// Silence, Classcheck!
//	DEFINE_ARRAY( CLogicCase, m_nCase, FIELD_STRING, MAX_LOGIC_CASES ),

	// Keys
	DEFINE_KEYFIELD(CLogicCase, m_nCase[0], FIELD_STRING, "Case01"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[1], FIELD_STRING, "Case02"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[2], FIELD_STRING, "Case03"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[3], FIELD_STRING, "Case04"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[4], FIELD_STRING, "Case05"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[5], FIELD_STRING, "Case06"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[6], FIELD_STRING, "Case07"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[7], FIELD_STRING, "Case08"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[8], FIELD_STRING, "Case09"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[9], FIELD_STRING, "Case10"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[10], FIELD_STRING, "Case11"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[11], FIELD_STRING, "Case12"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[12], FIELD_STRING, "Case13"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[13], FIELD_STRING, "Case14"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[14], FIELD_STRING, "Case15"),
	DEFINE_KEYFIELD(CLogicCase, m_nCase[15], FIELD_STRING, "Case16"),

	// Inputs
	DEFINE_INPUTFUNC(CLogicCase, FIELD_INPUT, "InValue", InputValue),
	DEFINE_INPUTFUNC(CLogicCase, FIELD_VOID, "PickRandom", InputPickRandom),

	// Outputs
	DEFINE_OUTPUT(CLogicCase, m_OnCase[0], "OnCase01"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[1], "OnCase02"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[2], "OnCase03"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[3], "OnCase04"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[4], "OnCase05"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[5], "OnCase06"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[6], "OnCase07"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[7], "OnCase08"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[8], "OnCase09"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[9], "OnCase10"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[10], "OnCase11"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[11], "OnCase12"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[12], "OnCase13"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[13], "OnCase14"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[14], "OnCase15"),
	DEFINE_OUTPUT(CLogicCase, m_OnCase[15], "OnCase16"),

	DEFINE_OUTPUT(CLogicCase, m_OnDefault, "OnDefault"),
...
BEGIN_DATADESC( CLogicCompare )
	...
	// Keys
	DEFINE_KEYFIELD(CLogicCompare, m_flCompareValue, FIELD_FLOAT, "CompareValue"),
	DEFINE_KEYFIELD(CLogicCompare, m_flInValue, FIELD_FLOAT, "InitialValue"),

	// Inputs
	DEFINE_INPUTFUNC(CLogicCompare, FIELD_FLOAT, "SetValue", InputSetValue),
	DEFINE_INPUTFUNC(CLogicCompare, FIELD_FLOAT, "SetValueCompare", InputSetValueCompare),
	DEFINE_INPUTFUNC(CLogicCompare, FIELD_FLOAT, "SetCompareValue", InputSetCompareValue),
	DEFINE_INPUTFUNC(CLogicCompare, FIELD_VOID, "Compare", InputCompare),

	// Outputs
	DEFINE_OUTPUT(CLogicCompare, m_OnEqualTo, "OnEqualTo"),
	DEFINE_OUTPUT(CLogicCompare, m_OnNotEqualTo, "OnNotEqualTo"),
	DEFINE_OUTPUT(CLogicCompare, m_OnGreaterThan, "OnGreaterThan"),
	DEFINE_OUTPUT(CLogicCompare, m_OnLessThan, "OnLessThan"),
...
BEGIN_DATADESC( CLogicBranch )
	...
	// Keys
	DEFINE_KEYFIELD(CLogicBranch, m_bInValue, FIELD_BOOLEAN, "InitialValue"),

	// Inputs
	DEFINE_INPUT(CLogicBranch, m_bInValue, FIELD_BOOLEAN, "SetValue"),
	DEFINE_INPUTFUNC(CLogicBranch, FIELD_BOOLEAN, "SetValueTest", InputSetValueTest),
	DEFINE_INPUTFUNC(CLogicBranch, FIELD_VOID, "Test", InputTest),

	// Outputs
	DEFINE_OUTPUT(CLogicBranch, m_OnTrue, "OnTrue"),
	DEFINE_OUTPUT(CLogicBranch, m_OnFalse, "OnFalse"),
...
BEGIN_DATADESC( CLogicAutosave )
	// Inputs
	DEFINE_INPUTFUNC( CLogicAutosave, FIELD_VOID, "Save", InputSave ),
END_DATADESC()
