...
BEGIN_DATADESC( CNPC_Launcher )
	...
	// Inputs
	DEFINE_KEYFIELD( CNPC_Launcher, m_nStartOn,					FIELD_INTEGER,	"StartOn" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_sMissileModel,			FIELD_STRING,	"MissileModel" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_sLaunchSound,				FIELD_STRING,	"LaunchSound" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_sFlySound,				FIELD_STRING,	"FlySound" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_nSmokeTrail,				FIELD_INTEGER,	"SmokeTrail" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_bSmokeLaunch,				FIELD_BOOLEAN,	"LaunchSmoke" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_nLaunchDelay,				FIELD_INTEGER,	"LaunchDelay" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flLaunchSpeed,			FIELD_FLOAT,	"LaunchSpeed" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_sPathCornerName,			FIELD_STRING,	"PathCornerName" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flHomingSpeed,			FIELD_FLOAT,	"HomingSpeed" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_nHomingStrength,			FIELD_INTEGER,	"HomingStrength" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flHomingDelay,			FIELD_FLOAT,	"HomingDelay" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flHomingRampUp,			FIELD_FLOAT,	"HomingRampUp" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flHomingDuration,			FIELD_FLOAT,	"HomingDuration" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flHomingRampDown,			FIELD_FLOAT,	"HomingRampDown" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flGravity,				FIELD_FLOAT,	"Gravity" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flMinAttackDist,			FIELD_FLOAT,	"MinRange" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flMaxAttackDist,			FIELD_FLOAT,	"MaxRange" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flSpinMagnitude,			FIELD_FLOAT,	"SpinMagnitude" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flSpinSpeed,				FIELD_FLOAT,	"SpinSpeed" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flDamage,					FIELD_FLOAT,	"Damage" ),
	DEFINE_KEYFIELD( CNPC_Launcher, m_flDamageRadius,			FIELD_FLOAT,	"DamageRadius" ),
	DEFINE_FIELD( CNPC_Launcher, m_flMissileGravity, FIELD_FLOAT ),

	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_VOID, "TurnOn", InputTurnOn ),
	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_VOID, "TurnOff", InputTurnOff ),
	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_VOID, "LOSCheckOn", InputLOSCheckOn ),
	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_VOID, "LOSCheckOn", InputLOSCheckOn ),
	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_VOID, "FireOnce", InputFireOnce ),
	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_EHANDLE, "SetEnemyEntity", InputSetEnemy ),
	DEFINE_INPUTFUNC( CNPC_Launcher, FIELD_VOID, "ClearEnemyEntity", InputClearEnemy ),

	DEFINE_OUTPUT( CNPC_Launcher, m_OnLaunch, "OnLaunch" ),

	// Function Pointers
	DEFINE_THINKFUNC( CNPC_Launcher, LauncherThink ),
...
void CNPC_Launcher::Precache( void )
{
	...
	enginesound->PrecacheSound( STRING(m_sLaunchSound));
	enginesound->PrecacheSound( STRING(m_sFlySound));
...
void CNPC_Launcher::LaunchGrenade( CBaseEntity* pEnemy )
{
	...
	EmitSound( filter, entindex(), CHAN_WEAPON, STRING(m_sLaunchSound), 1.0, 0.3, 1,100);
	if (m_bSmokeLaunch)
	{
