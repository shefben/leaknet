...
BEGIN_DATADESC( CGrenadeEnergy )
	...
	DEFINE_FIELD( CGrenadeEnergy, m_flMaxFrame,	  FIELD_INTEGER ),
	DEFINE_FIELD( CGrenadeEnergy, m_nEnergySprite, FIELD_INTEGER ),
	DEFINE_FIELD( CGrenadeEnergy, m_flLaunchTime, FIELD_TIME ),		

	// Function pointers
	DEFINE_FUNCTION( CGrenadeEnergy, Animate ),
	DEFINE_FUNCTION( CGrenadeEnergy, GrenadeEnergyTouch ),
...
void CGrenadeEnergy::GrenadeEnergyTouch( CBaseEntity *pOther )
{
	if ( pOther->m_takedamage )
	{
		...
		CTakeDamageInfo info( this, GetOwner(), m_flDamage * flLifeLeft, DMG_SONIC );
