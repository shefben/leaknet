...
BEGIN_DATADESC( CPlayer_Missile )
	...
	DEFINE_KEYFIELD( CPlayer_Missile,	m_flLaunchDelay,	FIELD_FLOAT, "LaunchDelay"),
	DEFINE_KEYFIELD( CPlayer_Missile,	m_flDamage,			FIELD_FLOAT, "Damage"),
	DEFINE_KEYFIELD( CPlayer_Missile,	m_flDamageRadius,	FIELD_FLOAT, "DamageRadius"),


	// Fields
	DEFINE_FIELD( CPlayer_Missile,	m_hSmokeTrail,		FIELD_EHANDLE),
	DEFINE_FIELD( CPlayer_Missile,	m_vSpawnPos,		FIELD_POSITION_VECTOR ),
	DEFINE_FIELD( CPlayer_Missile,	m_vSpawnAng,		FIELD_VECTOR ),
	DEFINE_FIELD( CPlayer_Missile,	m_vBounceVel,		FIELD_VECTOR ),
	DEFINE_FIELD( CPlayer_Missile,	m_bShake,			FIELD_BOOLEAN ),
	...
	DEFINE_FUNCTION( CPlayer_Missile, FlyThink ),
	DEFINE_FUNCTION( CPlayer_Missile, ExplodeThink ),
	DEFINE_FUNCTION( CPlayer_Missile, RemoveThink ),
	DEFINE_FUNCTION( CPlayer_Missile, FlyTouch ),
