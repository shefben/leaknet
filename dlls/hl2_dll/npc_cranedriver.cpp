...
BEGIN_DATADESC( CNPC_CraneDriver )
	// Inputs
	DEFINE_INPUTFUNC( CNPC_CraneDriver, FIELD_STRING, "ForcePickup", InputForcePickup ),
	DEFINE_INPUTFUNC( CNPC_CraneDriver, FIELD_STRING, "ForceDrop", InputForceDrop ),

	//DEFINE_FIELD( CNPC_CraneDriver, m_hCrane, FIELD_EHANDLE ),
	DEFINE_FIELD( CNPC_CraneDriver, m_hPickupTarget, FIELD_EHANDLE ),
	DEFINE_FIELD( CNPC_CraneDriver, m_flDistanceToTarget, FIELD_FLOAT ),
	DEFINE_UTLVECTOR( CNPC_CraneDriver, m_PreviouslyPickedUpObjects, FIELD_EHANDLE ),
	DEFINE_FIELD( CNPC_CraneDriver, m_bForcedPickup, FIELD_BOOLEAN ),
	DEFINE_FIELD( CNPC_CraneDriver, m_bForcedDropoff, FIELD_BOOLEAN ),
	DEFINE_FIELD( CNPC_CraneDriver, m_flDropWait, FIELD_FLOAT ),
	DEFINE_KEYFIELD( CNPC_CraneDriver, m_flReleasePause, FIELD_FLOAT, "releasepause" ),
	DEFINE_FIELD( CNPC_CraneDriver, m_flReleaseAt, FIELD_FLOAT ),

	// Outputs
	DEFINE_OUTPUT( CNPC_CraneDriver, m_OnPickedUpObject, "OnPickedUpObject" ),
	DEFINE_OUTPUT( CNPC_CraneDriver, m_OnDroppedObject, "OnDroppedObject" ),
	DEFINE_OUTPUT( CNPC_CraneDriver, m_OnPausingBeforeDrop, "OnPausingBeforeDrop" ),
