...
BEGIN_DATADESC( CBaseTurret )
	...
	DEFINE_FIELD( CBaseTurret, m_iAmmoType, FIELD_INTEGER ),

	DEFINE_FIELD( CBaseTurret, m_flPingTime, FIELD_TIME ),
	DEFINE_FIELD( CBaseTurret, m_flDamageTime, FIELD_TIME ),

	// Function pointers
	//DEFINE_USEFUNC( CBaseTurret, TurretUse ),
	DEFINE_THINKFUNC( CBaseTurret, ActiveThink ),
	DEFINE_THINKFUNC( CBaseTurret, SearchThink ),
	DEFINE_THINKFUNC( CBaseTurret, AutoSearchThink ),
	DEFINE_THINKFUNC( CBaseTurret, TurretDeath ),
	DEFINE_THINKFUNC( CBaseTurret, Deploy ),
	DEFINE_THINKFUNC( CBaseTurret, Retire ),
	DEFINE_THINKFUNC( CBaseTurret, Initialize ),

	// Inputs
	DEFINE_INPUTFUNC( CBaseTurret, FIELD_VOID, "Toggle", InputToggle ),
	
	// Outputs
	DEFINE_OUTPUT(CBaseTurret, m_OnDeploy, "OnDeploy"),
	DEFINE_OUTPUT(CBaseTurret, m_OnRetire, "OnRetire"),
...
{ 
	...
	m_iAmmoType = g_pGameRules->GetAmmoDef()->Index("SmallRound");
...
BEGIN_DATADESC( CSentry )
	...
	// Function pointers
	DEFINE_ENTITYFUNC( CSentry, SentryTouch ),
	DEFINE_THINKFUNC( CSentry, SentryDeath ),
