...
BEGIN_DATADESC( CLookDoorThinker )
	...
	DEFINE_FIELD( CLookDoorThinker, m_hLookDoor, FIELD_EHANDLE ),

	// Function Pointers
	DEFINE_FUNCTION(CLookDoorThinker, LookThink),
...
BEGIN_DATADESC( CLookDoor )
	...
	DEFINE_KEYFIELD( CLookDoor, m_flProximityDistance,	FIELD_FLOAT, "ProximityDistance"),
	DEFINE_KEYFIELD( CLookDoor, m_flProximityOffset,	FIELD_FLOAT, "ProximityOffset"),
	DEFINE_KEYFIELD( CLookDoor, m_flFieldOfView,		FIELD_FLOAT, "FieldOfView" ),
	DEFINE_FIELD(CLookDoor,		m_hLooker,				FIELD_EHANDLE),

	// Inputs
	DEFINE_INPUTFUNC( CLookDoor,	FIELD_VOID,		"InvertOn",		InputInvertOn ),
	DEFINE_INPUTFUNC( CLookDoor,	FIELD_VOID,		"InvertOff",	InputInvertOff ),

	// Function Pointers
	DEFINE_FUNCTION(CLookDoor, MoveThink),
