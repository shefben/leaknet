...
BEGIN_DATADESC( CWeaponMolotov )
	...
	DEFINE_FIELD( CWeaponMolotov, m_nNumAmmoTypes, FIELD_INTEGER ),
	DEFINE_FIELD( CWeaponMolotov, m_bNeedDraw, FIELD_BOOLEAN ),
	DEFINE_FIELD( CWeaponMolotov, m_iThrowBits, FIELD_INTEGER ),
	DEFINE_FIELD( CWeaponMolotov, m_fNextThrowCheck, FIELD_TIME ),
	DEFINE_FIELD( CWeaponMolotov, m_vecTossVelocity, FIELD_VECTOR ),
