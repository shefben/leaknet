...
// Animation events.
//
extern int ZOMBIE_AE_ATTACK_RIGHT;
extern int ZOMBIE_AE_ATTACK_LEFT;
extern int ZOMBIE_AE_ATTACK_BOTH;
extern int ZOMBIE_AE_SWATITEM;
extern int ZOMBIE_AE_STARTSWAT;
extern int ZOMBIE_AE_STEP_LEFT;
extern int ZOMBIE_AE_STEP_RIGHT;
extern int ZOMBIE_AE_SCUFF_LEFT;
extern int ZOMBIE_AE_SCUFF_RIGHT;
extern int ZOMBIE_AE_ATTACK_SCREAM;
extern int ZOMBIE_AE_GET_UP;
extern int ZOMBIE_AE_POUND;
