...
BEGIN_DATADESC( CGrenadeHomer )
	...
	DEFINE_ARRAY( CGrenadeHomer,	m_hRocketTrail,					FIELD_EHANDLE, 3 ),
	DEFINE_FIELD( CGrenadeHomer,	m_sFlySound,					FIELD_STRING),
	DEFINE_FIELD( CGrenadeHomer,	m_flNextFlySoundTime,			FIELD_TIME),

	DEFINE_FIELD( CGrenadeHomer,	m_flHomingStrength,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingDelay,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingRampUp,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingDuration,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingRampDown,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingSpeed,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flSpinMagnitude,				FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_flSpinSpeed,					FIELD_FLOAT),
	DEFINE_FIELD( CGrenadeHomer,	m_nRocketTrailType,				FIELD_INTEGER),

//	DEFINE_FIELD( CGrenadeHomer,	m_spriteTexture,				FIELD_INTEGER),

	DEFINE_FIELD( CGrenadeHomer,	m_flHomingLaunchTime,			FIELD_TIME),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingStartTime,			FIELD_TIME ),
	DEFINE_FIELD( CGrenadeHomer,	m_flHomingEndTime,				FIELD_TIME ),
	DEFINE_FIELD( CGrenadeHomer,	m_flSpinOffset,					FIELD_FLOAT),
	
	DEFINE_FIELD( CGrenadeHomer,	m_hTarget,						FIELD_EHANDLE),


	// Function pointers
	DEFINE_FUNCTION( CGrenadeHomer, AimThink ),
	DEFINE_FUNCTION( CGrenadeHomer, GrenadeHomerTouch ),
...
void CGrenadeHomer::StartRocketTrail(void)
{
	...
	if(pRocketTrail)
	{
		...
		pRocketTrail->FollowEntity(entindex());
							...
							int					nRocketTrailType)
{
	...
	if ( pTarget )
	{
		CSoundEnt::InsertSound ( SOUND_DANGER, m_hTarget->GetAbsOrigin(), 300, 0.5 );
	}
}
