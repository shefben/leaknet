...
BEGIN_DATADESC( CLight )
	...
	DEFINE_FIELD( CLight, m_iCurrentFade, FIELD_CHARACTER),
	DEFINE_FIELD( CLight, m_iTargetFade, FIELD_CHARACTER),

	DEFINE_KEYFIELD( CLight, m_iStyle, FIELD_INTEGER, "style" ),
	DEFINE_KEYFIELD( CLight, m_iszPattern, FIELD_STRING, "pattern" ),

	// Fuctions
	DEFINE_FUNCTION( CLight, FadeThink ),

	// Inputs
	DEFINE_INPUTFUNC( CLight, FIELD_STRING, "SetPattern", InputSetPattern ),
	DEFINE_INPUTFUNC( CLight, FIELD_STRING, "FadeToPattern", InputFadeToPattern ),
	DEFINE_INPUTFUNC( CLight, FIELD_VOID,	"Toggle", InputToggle ),
	DEFINE_INPUTFUNC( CLight, FIELD_VOID,	"TurnOn", InputTurnOn ),
	DEFINE_INPUTFUNC( CLight, FIELD_VOID,	"TurnOff", InputTurnOff ),
