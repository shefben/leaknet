...
BEGIN_DATADESC( CTeamSpawnPoint )
	...
	// keys
	DEFINE_KEYFIELD( CTeamSpawnPoint, m_iDisabled, FIELD_INTEGER, "StartDisabled" ),

	// input functions
	DEFINE_INPUTFUNC( CTeamSpawnPoint, FIELD_VOID, "Enable", InputEnable ),
	DEFINE_INPUTFUNC( CTeamSpawnPoint, FIELD_VOID, "Disable", InputDisable ),

	// outputs
	DEFINE_OUTPUT( CTeamSpawnPoint, m_OnPlayerSpawn, "OnPlayerSpawn" ),
...
BEGIN_DATADESC( CTeamVehicleSpawnPoint )
	...
	// outputs
	DEFINE_OUTPUT( CTeamVehicleSpawnPoint, m_OnVehicleSpawn, "OnVehicleSpawn" ),
