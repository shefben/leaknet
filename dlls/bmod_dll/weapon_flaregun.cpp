...
BEGIN_DATADESC( CFlare )
	...
	DEFINE_FIELD( CFlare, m_pOwner,			FIELD_CLASSPTR ),
	DEFINE_FIELD( CFlare, m_nBounces,		FIELD_INTEGER ),
	DEFINE_FIELD( CFlare, m_flTimeBurnOut,	FIELD_TIME ),
	DEFINE_KEYFIELD( CFlare, m_flScale,		FIELD_FLOAT, "scale" ),
	DEFINE_KEYFIELD( CFlare, m_flDuration,	FIELD_FLOAT, "duration" ),
	DEFINE_FIELD( CFlare, m_flNextDamage,	FIELD_TIME ),
	DEFINE_SOUNDPATCH( CFlare, m_pBurnSound ),
	DEFINE_FIELD( CFlare, m_bFading,		FIELD_BOOLEAN ),
	DEFINE_FIELD( CFlare, m_bLight,			FIELD_BOOLEAN ),
	DEFINE_FIELD( CFlare, m_bSmoke,			FIELD_BOOLEAN ),

	//Input functions
	DEFINE_INPUTFUNC( CFlare, FIELD_FLOAT, "Start", InputStart ),
	DEFINE_INPUTFUNC( CFlare, FIELD_FLOAT, "Die", InputDie ),
	DEFINE_INPUTFUNC( CFlare, FIELD_VOID, "Launch", InputLaunch),

	// Function Pointers
	DEFINE_FUNCTION( CFlare, FlareTouch ),
	DEFINE_FUNCTION( CFlare, FlareBurnTouch ),
	DEFINE_FUNCTION( CFlare, FlareThink ),
