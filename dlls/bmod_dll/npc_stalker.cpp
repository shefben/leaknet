...
BEGIN_DATADESC( CNPC_Stalker )
	...
	DEFINE_KEYFIELD( CNPC_Stalker,	m_eBeamPower,		FIELD_INTEGER,	"BeamPower" ),
	DEFINE_FIELD( CNPC_Stalker,	m_vLaserDir,			FIELD_VECTOR),
	DEFINE_FIELD( CNPC_Stalker,	m_vLaserTargetPos,		FIELD_POSITION_VECTOR),
	DEFINE_FIELD( CNPC_Stalker,	m_fBeamEndTime,			FIELD_FLOAT),
	DEFINE_FIELD( CNPC_Stalker,	m_fBeamRechargeTime,	FIELD_FLOAT),
	DEFINE_FIELD( CNPC_Stalker,	m_fNextDamageTime,		FIELD_FLOAT),
	DEFINE_FIELD( CNPC_Stalker,	m_bPlayingHitWall,		FIELD_FLOAT),
	DEFINE_FIELD( CNPC_Stalker,	m_bPlayingHitFlesh,		FIELD_FLOAT),
	DEFINE_FIELD( CNPC_Stalker,	m_pBeam,				FIELD_CLASSPTR),
	DEFINE_FIELD( CNPC_Stalker,	m_pLightGlow,			FIELD_CLASSPTR),
	DEFINE_FIELD( CNPC_Stalker,	m_flNextNPCThink,		FIELD_FLOAT),
	DEFINE_FIELD( CNPC_Stalker,	m_pScriptedTarget,		FIELD_CLASSPTR),
	DEFINE_FIELD( CNPC_Stalker,	m_vLaserCurPos,			FIELD_POSITION_VECTOR),
	DEFINE_FIELD( CNPC_Stalker, m_flNextAttackSoundTime, FIELD_TIME ),
	DEFINE_FIELD( CNPC_Stalker, m_flNextBreatheSoundTime, FIELD_TIME ),
	DEFINE_FIELD( CNPC_Stalker, m_flNextScrambleSoundTime, FIELD_TIME ),
	DEFINE_FIELD( CNPC_Stalker, m_nextSmokeTime, FIELD_TIME ),

	// Function Pointers
	DEFINE_THINKFUNC( CNPC_Stalker, StalkerThink ),
...
//		Msg( "Stalker Beam restart!\n" );
	...
	if (!m_pBeam)
	{
		...
		{
			EmitAmbientSound( GetWorldEntity(), pEnemy->GetAbsOrigin(), "NPC_Stalker.AmbientLaserStart" );
		}
		else
		{
			EmitAmbientSound( GetWorldEntity(), GetAbsOrigin(), "NPC_Stalker.AmbientLaserStart" );
		}
	}
	...
	switch( pEvent->event )
	{
		...
		case STALKER_AE_MELEE_HIT:
		{
			...
			if ( pHurt )
			{
				...
				if (pBCC)
				{
					SpawnBlood(pBCC->EyePosition(), pBCC->BloodColor(), sk_stalker_melee_dmg.GetFloat());
				}
...
// Output :
//-----------------------------------------------------------------------------
Activity CNPC_Stalker::GetHintActivity( short sHintType )
{
