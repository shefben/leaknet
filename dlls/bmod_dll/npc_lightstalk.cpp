...
#define	LIGHTSTALK_MODEL			"models/lightstalk.mdl"
...
BEGIN_DATADESC( CNPC_LightStalk )
	...
	DEFINE_FIELD( CNPC_LightStalk, m_pGlow,				FIELD_CLASSPTR ),
	DEFINE_FIELD( CNPC_LightStalk, m_flStartFadeTime,	FIELD_TIME ),
	DEFINE_FIELD( CNPC_LightStalk, m_nFadeDir,			FIELD_INTEGER ),
	DEFINE_FIELD( CNPC_LightStalk, m_flHideEndTime,		FIELD_TIME ),

	// outputs
	DEFINE_OUTPUT( CNPC_LightStalk, m_OnRise,  "OnRise" ),
	DEFINE_OUTPUT( CNPC_LightStalk, m_OnLower, "OnLower" ),
