...
BEGIN_DATADESC( CWeaponGaussGun )
	...
	DEFINE_FIELD( CWeaponGaussGun, m_hViewModel,		FIELD_EHANDLE ),
	DEFINE_FIELD( CWeaponGaussGun, m_flNextChargeTime,	FIELD_TIME ),
	DEFINE_SOUNDPATCH( CWeaponGaussGun, m_sndCharge ),
	DEFINE_FIELD( CWeaponGaussGun, m_flChargeStartTime,	FIELD_TIME ),
	DEFINE_FIELD( CWeaponGaussGun, m_bCharging,			FIELD_BOOLEAN ),
	DEFINE_FIELD( CWeaponGaussGun, m_bChargeIndicated,	FIELD_BOOLEAN ),
	DEFINE_FIELD( CWeaponGaussGun, m_flCoilMaxVelocity,	FIELD_FLOAT ),
	DEFINE_FIELD( CWeaponGaussGun, m_flCoilVelocity,	FIELD_FLOAT ),
	DEFINE_FIELD( CWeaponGaussGun, m_flCoilAngle,		FIELD_FLOAT ),
