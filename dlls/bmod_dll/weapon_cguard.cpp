...
BEGIN_DATADESC( CWeaponCGuard )
	...
	DEFINE_FIELD( CWeaponCGuard, m_flChargeTime,	FIELD_TIME ),
	DEFINE_FIELD( CWeaponCGuard, m_bFired,			FIELD_BOOLEAN ),
//	DEFINE_FIELD( CWeaponCGuard, m_beamIndex,		FIELD_INTEGER ),
//	DEFINE_FIELD( CWeaponCGuard, m_haloIndex,		FIELD_INTEGER ),
