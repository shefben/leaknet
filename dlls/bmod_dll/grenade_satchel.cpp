...
BEGIN_DATADESC( CSatchelCharge )
	...
	DEFINE_SOUNDPATCH( CSatchelCharge, m_soundSlide ),

	DEFINE_FIELD( CSatchelCharge, m_flSlideVolume, FIELD_FLOAT ),
	...
	DEFINE_FIELD( CSatchelCharge, m_pMyWeaponSLAM, FIELD_CLASSPTR ),
	DEFINE_FIELD( CSatchelCharge, m_bIsAttached, FIELD_BOOLEAN ),
...
void CSatchelCharge::SatchelTouch( CBaseEntity *pOther )
{
	...
	if ( pOther == GetOwner() && GetOwnerEntity() == NULL )
	{
