...
BEGIN_DATADESC( CPropJetski )
	...
	DEFINE_AUTO_ARRAY( CPropJetski, m_flSpringLengthApproach, FIELD_FLOAT ),
	DEFINE_AUTO_ARRAY( CPropJetski, m_flFrictionWheels, FIELD_FLOAT ),
	DEFINE_FIELD( CPropJetski, m_flHandbrakeTime, FIELD_TIME ),
	DEFINE_FIELD( CPropJetski, m_bInitialHandbrake, FIELD_BOOLEAN ),
	DEFINE_AUTO_ARRAY( CPropJetski, m_springLen, FIELD_FLOAT ),
	DEFINE_PHYSPTR( CPropJetski, m_pVehicle ),
