...
// bit string, AI conditions. This assumes MAX_CONDITIONS == 96

template<> 
inline void CBitStringT< CFixedBitStringBase<96> >::And(const CBitStringT &addStr, CBitStringT *out) const
{
	int *	   pDest		= out->GetInts();
...
template<> 
inline bool CBitStringT< CFixedBitStringBase<96> >::IsAllClear(void) const
{
...
template<> 
inline void CBitStringT< CFixedBitStringBase<96> >::Copy(CBitStringT *out) const
{
	int *	   pDest = out->GetInts();
	const int *pInts = GetInts();
