...
BEGIN_DATADESC( CEnvSpark )
	...
	DEFINE_KEYFIELD( CEnvSpark, m_flDelay, FIELD_FLOAT, "MaxDelay" ),
	DEFINE_FIELD( CEnvSpark, m_nGlowSpriteIndex, FIELD_INTEGER ),
	DEFINE_KEYFIELD( CEnvSpark, m_nMagnitude, FIELD_INTEGER, "Magnitude" ),
	DEFINE_KEYFIELD( CEnvSpark, m_nTrailLength, FIELD_INTEGER, "TrailLength" ),

	// Function Pointers
	DEFINE_FUNCTION( CEnvSpark, SparkThink ),

	DEFINE_INPUTFUNC( CEnvSpark, FIELD_VOID, "StartSpark", InputStartSpark ),
	DEFINE_INPUTFUNC( CEnvSpark, FIELD_VOID, "StopSpark", InputStopSpark ),
	DEFINE_INPUTFUNC( CEnvSpark, FIELD_VOID, "ToggleSpark", InputToggleSpark ),
	DEFINE_INPUTFUNC( CEnvSpark, FIELD_VOID, "SparkOnce", InputSparkOnce ),

	DEFINE_OUTPUT( CEnvSpark, m_OnSpark, "OnSpark" ),
