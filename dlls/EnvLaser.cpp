...
BEGIN_DATADESC( CEnvLaser )
	...
	DEFINE_KEYFIELD( CEnvLaser, m_iszLaserTarget, FIELD_STRING, "LaserTarget" ),
	DEFINE_FIELD( CEnvLaser, m_pSprite, FIELD_CLASSPTR ),
	DEFINE_KEYFIELD( CEnvLaser, m_iszSpriteName, FIELD_STRING, "EndSprite" ),
	DEFINE_FIELD( CEnvLaser, m_firePosition, FIELD_VECTOR ),
	DEFINE_KEYFIELD( CEnvLaser, m_flStartFrame, FIELD_FLOAT, "framestart" ),

	// Function Pointers
	DEFINE_FUNCTION( CEnvLaser, StrikeThink ),

	// Input functions
	DEFINE_INPUTFUNC( CEnvLaser, FIELD_VOID, "TurnOn", InputTurnOn ),
	DEFINE_INPUTFUNC( CEnvLaser, FIELD_VOID, "TurnOff", InputTurnOff ),
	DEFINE_INPUTFUNC( CEnvLaser, FIELD_VOID, "Toggle", InputToggle ),
