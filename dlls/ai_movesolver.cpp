...
{
	{  0.20,  0.80 },	// AIMST_MOVE
	{ -0.30, -0.90 },	// AIMST_AVOID_DANGER
	{ -0.20, -0.80 },	// AIMST_AVOID_OBJECT
	{ -0.30, -0.80 },	// AIMST_AVOID_NPC
	{ -0.20, -0.80 },	// AIMST_AVOID_WORLD
...
CON_COMMAND(ai_test_move_solver, "Tests the AI move solver system")
{
...
#endif
	Msg( "Beginning move solver tests...\n" );
	...
	//
	{
	Msg( "Nearest solution, in tolerance... " );
