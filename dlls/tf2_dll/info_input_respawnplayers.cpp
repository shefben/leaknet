...
BEGIN_DATADESC( CInfoInputRespawnPlayers )
	...
	// inputs
	DEFINE_INPUTFUNC( CInfoInputRespawnPlayers, FIELD_VOID, "RespawnAll", InputRespawnAll ),
	DEFINE_INPUTFUNC( CInfoInputRespawnPlayers, FIELD_VOID, "RespawnTeam1", InputRespawnTeam1 ),
	DEFINE_INPUTFUNC( CInfoInputRespawnPlayers, FIELD_VOID, "RespawnTeam2", InputRespawnTeam2 ),
	DEFINE_INPUTFUNC( CInfoInputRespawnPlayers, FIELD_EHANDLE, "RespawnPlayer", InputRespawnPlayer ),
