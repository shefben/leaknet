...
BEGIN_DATADESC( CInfoMinimapPulse )
	...
	// inputs
	DEFINE_INPUTFUNC( CInfoMinimapPulse, FIELD_VOID, "PulseForAll", InputPulseForAll ),
	DEFINE_INPUTFUNC( CInfoMinimapPulse, FIELD_VOID, "PulseForTeam1", InputPulseForTeam1 ),
	DEFINE_INPUTFUNC( CInfoMinimapPulse, FIELD_VOID, "PulseForTeam2", InputPulseForTeam2 ),
	DEFINE_INPUTFUNC( CInfoMinimapPulse, FIELD_EHANDLE, "PulseForPlayer", InputPulseForPlayer ),
...
void CInfoMinimapPulse::InputPulseForAll( inputdata_t &inputdata )
{
	...
	{
		PulseForTeam( GetGlobalTFTeam(i+1) );
	}
}
