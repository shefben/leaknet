...
// Rock models
const char *sRockModels[ MAX_ROCK_MODELS ] =
{
...
BEGIN_DATADESC( CFallingRock )
	...
	// functions
	DEFINE_FUNCTION( CFallingRock, RockTouch ),
...
BEGIN_DATADESC( CEnv_FallingRocks )
	...
	// Fields
	DEFINE_KEYFIELD( CEnv_FallingRocks, m_flFallStrength, FIELD_FLOAT, "FallSpeed"),
	DEFINE_KEYFIELD( CEnv_FallingRocks, m_flRotationSpeed, FIELD_FLOAT, "RotationSpeed"),
	DEFINE_KEYFIELD( CEnv_FallingRocks, m_flMinSpawnTime, FIELD_FLOAT, "MinSpawnTime"),
	DEFINE_KEYFIELD( CEnv_FallingRocks, m_flMaxSpawnTime, FIELD_FLOAT, "MaxSpawnTime"),

	// Inputs
	DEFINE_INPUTFUNC( CEnv_FallingRocks, FIELD_VOID,	"SpawnRock",	InputSpawnRock ),

	// Outputs
	DEFINE_OUTPUT( CEnv_FallingRocks, m_pOutputRockSpawned,	"OnRockSpawned" ),

	// Functions
	DEFINE_FUNCTION( CEnv_FallingRocks, RockThink ),
