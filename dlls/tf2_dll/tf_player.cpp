...
BEGIN_DATADESC( CBaseTFPlayer )
	...
	DEFINE_INPUTFUNC( CBaseTFPlayer, FIELD_VOID, "Respawn", InputRespawn ),

	// Function Pointers
	DEFINE_THINKFUNC( CBaseTFPlayer, TFPlayerDeathThink ),
...
BEGIN_PREDICTION_DATA_NO_BASE( CTFPlayerLocalData )
	...
	DEFINE_FIELD( CTFPlayerLocalData, m_nInTacticalView, FIELD_INTEGER ),
	DEFINE_FIELD( CTFPlayerLocalData, m_bKnockedDown, FIELD_BOOLEAN ),
	DEFINE_FIELD( CTFPlayerLocalData, m_vecKnockDownDir, FIELD_VECTOR ),
	DEFINE_FIELD( CTFPlayerLocalData, m_bThermalVision, FIELD_BOOLEAN ),
	DEFINE_FIELD( CTFPlayerLocalData, m_iIDEntIndex, FIELD_INTEGER ),
	DEFINE_FIELD( CTFPlayerLocalData, m_iBankResources, FIELD_INTEGER ),
	DEFINE_ARRAY( CTFPlayerLocalData, m_iResourceAmmo, FIELD_INTEGER, RESOURCE_TYPES ),
	//DEFINE_ARRAY( CTFPlayerLocalData, m_aObjects, FIELD_EHANDLE, MAX_OBJECTS_PER_PLAYER ),
	DEFINE_FIELD( CTFPlayerLocalData, m_bAttachingSapper, FIELD_BOOLEAN ),
	DEFINE_FIELD( CTFPlayerLocalData, m_flSapperAttachmentFrac, FIELD_FLOAT ),
	DEFINE_FIELD( CTFPlayerLocalData, m_bForceMapOverview, FIELD_BOOLEAN ),
...
BEGIN_PREDICTION_DATA( CBaseTFPlayer )
	...
	// DEFINE_FIELD( CBaseTFPlayer, m_pfnClassTouch, void (CPlayerClass ::*m_pfnClassTouch ),
	DEFINE_FIELD( CBaseTFPlayer, m_bWasMoving, FIELD_BOOLEAN ),
	// DEFINE_FIELD( CBaseTFPlayer, m_hSpawnPoint, EHANDLE ),
	DEFINE_PRED_TYPEDESCRIPTION( CBaseTFPlayer, m_TFLocal, CTFPlayerLocalData ),
	// DEFINE_FIELD( CBaseTFPlayer, m_hWeaponBuilder, CHandle < CWeaponBuilder > ),
	DEFINE_FIELD( CBaseTFPlayer, m_flKnockdownEndTime, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_vecDeployedAngles, FIELD_VECTOR ),
	DEFINE_FIELD( CBaseTFPlayer, m_nMedicDamageBoosts, FIELD_INTEGER ),
	DEFINE_FIELD( CBaseTFPlayer, m_TFPlayerFlags, FIELD_INTEGER ),
	DEFINE_FIELD( CBaseTFPlayer, m_bCantMove, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_bGagged, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_flLastAttackTime, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flCamouflageAmount, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flGoalCamouflageAmount, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flGoalCamouflageChangeRate, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_bSwitchingView, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_iPlayerClass, FIELD_INTEGER ),
	// DEFINE_FIELD( CBaseTFPlayer, m_pCurrentZone, CControlZone ),
	DEFINE_FIELD( CBaseTFPlayer, m_iCurrentZoneState, FIELD_INTEGER ),
	DEFINE_FIELD( CBaseTFPlayer, m_bSnapAccuracy, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_flAccuracy, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flTargetAccuracy, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flLastRicochetNearby, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flNumberOfRicochets, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flLastExplosionNearby, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_vecPosDelta, FIELD_VECTOR ),
	DEFINE_ARRAY( CBaseTFPlayer, m_aMomentum, FIELD_FLOAT, CBaseTFPlayer::MOMENTUM_MAXSIZE ),
	DEFINE_FIELD( CBaseTFPlayer, m_iMomentumHead, FIELD_INTEGER ),
	DEFINE_FIELD( CBaseTFPlayer, m_bBuffHealthBoost, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_iHealthBoostTarget, FIELD_INTEGER ),
	DEFINE_FIELD( CBaseTFPlayer, m_flHealthBoostDecrement, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_flHealthBoostTime, FIELD_FLOAT ),
	// DEFINE_FIELD( CBaseTFPlayer, m_hNextPlayerToUpdateOnRadar, EHANDLE ),
	// DEFINE_FIELD( CBaseTFPlayer, m_hSelectedOrder, CHandle < COrder > ),
	// DEFINE_FIELD( CBaseTFPlayer, m_pVehicle, IVehicle ),
	DEFINE_FIELD( CBaseTFPlayer, m_nPreferredTechnology, FIELD_INTEGER ),
	// DEFINE_FIELD( CBaseTFPlayer, m_flLastTimeDamagedByEnemy, double ),
	// DEFINE_FIELD( CBaseTFPlayer, m_pCurrentMenu, CMenu ),
	DEFINE_FIELD( CBaseTFPlayer, m_MenuStringBuffer, FIELD_STRING ),
	DEFINE_FIELD( CBaseTFPlayer, m_MenuSelectionBuffer, FIELD_INTEGER ),
	DEFINE_FIELD( CBaseTFPlayer, m_MenuUpdateTime, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_MenuDisplayTime, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_MenuRefreshTime, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_bRampage, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_bIsBlocking, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_bIsParrying, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_flTimeOfDeath, FIELD_FLOAT ),
	DEFINE_FIELD( CBaseTFPlayer, m_bDeployed, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_bDeploying, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_bUnDeploying, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBaseTFPlayer, m_flFinishedDeploying, FIELD_FLOAT ),
	// DEFINE_ARRAY( CBaseTFPlayer, m_rgClientTechAvail, tfplayertech_t,  MAX_TECHNOLOGIES  ),
	// DEFINE_FIELD( CBaseTFPlayer, m_hRagdollShadow, CHandle < CRagdollShadow > ),
	DEFINE_FIELD( CBaseTFPlayer, m_iLastSecondsToGo, FIELD_INTEGER ),
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CBaseTFPlayer::ClientCommand(const char *cmd)
{
	if( HasClass() )
	{
		...
		if ( FStrEq( cmd, "dmg_target" ) )
		{
			...
			if ( pEntity && pEntity->m_takedamage )
			{
				...
				if ( engine->Cmd_Argc() == 2 )
				{
					flDamage = atof( engine->Cmd_Argv( 1 ) );
				}
	...
	if ( !_stricmp( cmd, "kd" ) )
	{
		...
		else
		{
			...
			if ( !_stricmp( engine->Cmd_Argv( 1 ), "f" ) )
			{
				force = fwd * -1.0f;
			}
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "b" ) )
			{
				force = fwd;
			}
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "r" ) )
			{
				force = right * -1.0f;
			}			
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "l" ) )
			{
				force = right;
			}
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "fr" ) )
			{
				force = fwd * -1.0f;
				force += right * -1.0f;
			}
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "br" ) )
			{
				force = fwd;
				force += right * -1.0f;
			}
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "fl" ) )
			{
				force = fwd * -1.0f;
				force += right;
			}			
			else if ( !_stricmp( engine->Cmd_Argv( 1 ), "bl" ) )
			{
				force = fwd;
				force += right;
			}
	...
	if ( FStrEq( cmd, "ragdoll" ) )
	{
		...
		if ( engine->Cmd_Argc()>=2 )
		{
			on = atoi( engine->Cmd_Argv( 1 ) ) ? true : false;
		}
	...
	if ( FStrEq( cmd, "hbset" ) )
	{
		if ( engine->Cmd_Argc() >= 2 )
		{
			SetHitboxSet( atoi( engine->Cmd_Argv( 1 ) ) );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseTFPlayer::ShouldTransmit( const edict_t *recipient, 
								    const void *pvs, int clientArea )
{
	...
	CBaseTFPlayer *pPlayer = ( ( CBaseTFPlayer * )CBaseEntity::Instance( recipient ) );
	if ( pPlayer )
	{
...
//			**pas - 
//-----------------------------------------------------------------------------
void CBaseTFPlayer::SetupVisibility( unsigned char *pvs, unsigned char *pas )
{
	// Normal PVS
