...
BEGIN_DATADESC( CInfoAct )
	...
	// inputs
	DEFINE_INPUTFUNC( CInfoAct, FIELD_VOID, "Start", InputStart ),
	DEFINE_INPUTFUNC( CInfoAct, FIELD_VOID, "FinishWinNone", InputFinishWinNone ),
	DEFINE_INPUTFUNC( CInfoAct, FIELD_VOID, "FinishWin1", InputFinishWin1 ),
	DEFINE_INPUTFUNC( CInfoAct, FIELD_VOID, "FinishWin2", InputFinishWin2 ),
	DEFINE_INPUTFUNC( CInfoAct, FIELD_FLOAT, "AddTime", InputAddTime ),

	// outputs
	DEFINE_OUTPUT( CInfoAct, m_OnStarted, "OnStarted" ),
	DEFINE_OUTPUT( CInfoAct, m_OnFinishedTeamNone, "OnFinishedWinNone" ),
	DEFINE_OUTPUT( CInfoAct, m_OnFinishedTeam1, "OnFinishedWin1" ),
	DEFINE_OUTPUT( CInfoAct, m_OnFinishedTeam2, "OnFinishedWin2" ),
	DEFINE_OUTPUT( CInfoAct, m_OnTimerExpired, "OnTimerExpired" ),

	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1Events[CInfoAct::RESPAWN_TIMER_90_REMAINING], "OnRespawn1Team1_90sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1Events[CInfoAct::RESPAWN_TIMER_60_REMAINING], "OnRespawn1Team1_60sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1Events[CInfoAct::RESPAWN_TIMER_45_REMAINING], "OnRespawn1Team1_45sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1Events[CInfoAct::RESPAWN_TIMER_30_REMAINING], "OnRespawn1Team1_30sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1Events[CInfoAct::RESPAWN_TIMER_10_REMAINING], "OnRespawn1Team1_10sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1Events[CInfoAct::RESPAWN_TIMER_0_REMAINING], "OnRespawn1Team1" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team1TimeRemaining, "Respawn1Team1TimeRemaining" ),

	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1Events[CInfoAct::RESPAWN_TIMER_90_REMAINING], "OnRespawn2Team1_90sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1Events[CInfoAct::RESPAWN_TIMER_60_REMAINING], "OnRespawn2Team1_60sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1Events[CInfoAct::RESPAWN_TIMER_45_REMAINING], "OnRespawn2Team1_45sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1Events[CInfoAct::RESPAWN_TIMER_30_REMAINING], "OnRespawn2Team1_30sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1Events[CInfoAct::RESPAWN_TIMER_10_REMAINING], "OnRespawn2Team1_10sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1Events[CInfoAct::RESPAWN_TIMER_0_REMAINING], "OnRespawn2Team1" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team1TimeRemaining, "Respawn2Team1TimeRemaining" ),

	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2Events[CInfoAct::RESPAWN_TIMER_90_REMAINING], "OnRespawn1Team2_90sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2Events[CInfoAct::RESPAWN_TIMER_60_REMAINING], "OnRespawn1Team2_60sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2Events[CInfoAct::RESPAWN_TIMER_45_REMAINING], "OnRespawn1Team2_45sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2Events[CInfoAct::RESPAWN_TIMER_30_REMAINING], "OnRespawn1Team2_30sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2Events[CInfoAct::RESPAWN_TIMER_10_REMAINING], "OnRespawn1Team2_10sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2Events[CInfoAct::RESPAWN_TIMER_0_REMAINING], "OnRespawn1Team2" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn1Team2TimeRemaining, "Respawn1Team2TimeRemaining" ),

	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2Events[CInfoAct::RESPAWN_TIMER_90_REMAINING], "OnRespawn2Team2_90sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2Events[CInfoAct::RESPAWN_TIMER_60_REMAINING], "OnRespawn2Team2_60sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2Events[CInfoAct::RESPAWN_TIMER_45_REMAINING], "OnRespawn2Team2_45sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2Events[CInfoAct::RESPAWN_TIMER_30_REMAINING], "OnRespawn2Team2_30sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2Events[CInfoAct::RESPAWN_TIMER_10_REMAINING], "OnRespawn2Team2_10sec" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2Events[CInfoAct::RESPAWN_TIMER_0_REMAINING], "OnRespawn2Team2" ),
	DEFINE_OUTPUT( CInfoAct, m_Respawn2Team2TimeRemaining, "Respawn2Team2TimeRemaining" ),

	DEFINE_OUTPUT( CInfoAct, m_Team1RespawnDelayDone, "OnTeam1RespawnDelayDone" ),
	DEFINE_OUTPUT( CInfoAct, m_Team2RespawnDelayDone, "OnTeam2RespawnDelayDone" ),

	// keys 
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_iActNumber, FIELD_INTEGER, "ActNumber" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_flActTimeLimit, FIELD_FLOAT, "ActTimeLimit" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_iszIntermissionCamera, FIELD_STRING, "IntermissionCamera" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_nRespawn1Team1Time, FIELD_INTEGER, "Respawn1Team1Time" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_nRespawn2Team1Time, FIELD_INTEGER, "Respawn2Team1Time" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_nRespawn1Team2Time, FIELD_INTEGER, "Respawn1Team2Time" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_nRespawn2Team2Time, FIELD_INTEGER, "Respawn2Team2Time" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_nRespawnTeam1Delay, FIELD_INTEGER, "RespawnTeam1InitialDelay" ),
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAct, m_nRespawnTeam2Delay, FIELD_INTEGER, "RespawnTeam2InitialDelay" ),

	// functions
	DEFINE_FUNCTION( CInfoAct, ActThink ),
	DEFINE_FUNCTION( CInfoAct, ActThinkEndActOverlayTime ),
	DEFINE_FUNCTION( CInfoAct, RespawnTimerThink ),
	DEFINE_FUNCTION( CInfoAct, Team1RespawnDelayThink ),
	DEFINE_FUNCTION( CInfoAct, Team2RespawnDelayThink ),
...
void CInfoAct::StartActOverlayTime( CBaseTFPlayer *pPlayer )
{
	...
	pPlayer->m_Local.m_iHideHUD |= (HIDEHUD_WEAPONS | HIDEHUD_HEALTH);
...
void CInfoAct::StartIntermission( CBaseTFPlayer *pPlayer )
{
	...
	if ( m_iszIntermissionCamera != NULL_STRING )
	{
		...
		if ( pCamera )
		{
			...
			pPlayer->m_Local.m_iHideHUD |= (HIDEHUD_WEAPONS | HIDEHUD_HEALTH | HIDEHUD_MISCSTATUS);
		}
	}
