...
#define WAGON_START_SOUND	"vehicles/diesel_start1.wav"
#define WAGON_RUNNING_SOUND "vehicles/diesel_loop2.wav"
#define WAGON_TURBO_SOUND	"vehicles/diesel_nitroboost.wav"
...
void CVehicleWagon::Precache()
{
	...
	enginesound->PrecacheSound( WAGON_START_SOUND );
	enginesound->PrecacheSound( WAGON_RUNNING_SOUND );
	enginesound->PrecacheSound( WAGON_TURBO_SOUND );
...
{
	SetVehicleSounds( WAGON_START_SOUND, WAGON_RUNNING_SOUND, NULL, WAGON_TURBO_SOUND );
