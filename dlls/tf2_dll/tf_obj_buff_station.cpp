...
BEGIN_DATADESC( CObjectBuffStation )
	DEFINE_INPUTFUNC( CObjectBuffStation, FIELD_VOID, "PlayerSpawned", InputPlayerSpawned ),
	DEFINE_INPUTFUNC( CObjectBuffStation, FIELD_VOID, "PlayerAttachedToGenerator", InputPlayerAttachedToGenerator ),
	DEFINE_INPUTFUNC( CObjectBuffStation, FIELD_VOID, "PlayerEnteredVehicle", InputPlayerSpawned ),	// NJS: Detach player from buff pack.
END_DATADESC()
