...
BEGIN_DATADESC( CSensorTFTeam )
	...
	DEFINE_OUTPUT( CSensorTFTeam, m_OnRespawnCountChanged, "OnRespawnCountChanged" ),
	DEFINE_OUTPUT( CSensorTFTeam, m_OnResourceCountChanged, "OnResourceCountChanged" ),
	DEFINE_OUTPUT( CSensorTFTeam, m_OnMemberCountChanged, "OnMemberCountChanged" ),
	DEFINE_OUTPUT( CSensorTFTeam, m_OnRespawnCountChangedDelta, "OnRespawnCountChangedDelta" ),
	DEFINE_OUTPUT( CSensorTFTeam, m_OnResourceCountChangedDelta, "OnResourceCountChangedDelta" ),
	DEFINE_OUTPUT( CSensorTFTeam, m_OnMemberCountChangedDelta, "OnMemberCountChangedDelta" ),
	DEFINE_KEYFIELD( CSensorTFTeam, m_nTeam, FIELD_INTEGER, "team"),
