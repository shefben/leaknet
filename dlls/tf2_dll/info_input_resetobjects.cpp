...
BEGIN_DATADESC( CInfoInputResetObjects )
	...
	// inputs
	DEFINE_INPUTFUNC( CInfoInputResetObjects, FIELD_VOID, "ResetAll", InputResetAll ),
	DEFINE_INPUTFUNC( CInfoInputResetObjects, FIELD_VOID, "ResetTeam1", InputResetTeam1 ),
	DEFINE_INPUTFUNC( CInfoInputResetObjects, FIELD_VOID, "ResetTeam2", InputResetTeam2 ),
	DEFINE_INPUTFUNC( CInfoInputResetObjects, FIELD_EHANDLE, "ResetPlayer", InputResetPlayer ),
