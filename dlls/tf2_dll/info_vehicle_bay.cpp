...
BEGIN_DATADESC( CVGuiScreenVehicleBay )
	// outputs
	DEFINE_OUTPUT( CVGuiScreenVehicleBay, m_OnStartedBuild, "OnStartedBuild" ),
	DEFINE_OUTPUT( CVGuiScreenVehicleBay, m_OnFinishedBuild, "OnFinishedBuild" ),
	DEFINE_OUTPUT( CVGuiScreenVehicleBay, m_OnReadyToBuildAgain, "OnReadyToBuildAgain" ),

	// functions
	DEFINE_FUNCTION( CVGuiScreenVehicleBay, BayThink ),
END_DATADESC()
