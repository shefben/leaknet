...
BEGIN_DATADESC( CShieldGrenade )
	...
	// Function Pointers
	DEFINE_FUNCTION( CShieldGrenade, StickyTouch ),
	DEFINE_FUNCTION( CShieldGrenade, BeepThink ),
	DEFINE_FUNCTION( CShieldGrenade, ShieldActiveThink ),
	DEFINE_FUNCTION( CShieldGrenade, DeathThink ),
