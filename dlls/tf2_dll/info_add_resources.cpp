...
BEGIN_DATADESC( CInfoAddResources )
	...
	// inputs
	DEFINE_INPUTFUNC( CInfoAddResources, FIELD_EHANDLE, "Player", InputPlayer ),

	// outputs
	DEFINE_OUTPUT( CInfoAddResources, m_OnAdded, "OnAdded" ),

	// keys 
	DEFINE_KEYFIELD_NOT_SAVED( CInfoAddResources, m_iResourceAmount, FIELD_INTEGER, "ResourceAmount" ),
