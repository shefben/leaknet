...
BEGIN_DATADESC( CNPC_Bug_Builder )
	...
	DEFINE_FIELD( CNPC_Bug_Builder, m_flIdleDelay,		FIELD_FLOAT ),
	...
	case BUG_WARRIOR_AE_MELEE_SOUND1:
		{
			...
			EmitSound( filter, entindex(), CHAN_WEAPON, RANDOM_SOUND_ARRAY( pAttackSoundsSingle ), 1.0f, ATTN_NORM, 0, 100 );
			return;
		}
		break;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Bug_Builder::PainSound( void )
{
