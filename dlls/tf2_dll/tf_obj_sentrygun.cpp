...
BEGIN_DATADESC( CObjectSentrygun )
	...
	DEFINE_THINKFUNC( CObjectSentrygun, SentryRotate ),
	DEFINE_THINKFUNC( CObjectSentrygun, Attack ),
...
bool CObjectSentrygunPlasma::Fire( void )
{
	...
	if ( !m_bSuppressing )
	{
		Vector vecVelocity = m_hEnemy->GetAbsVelocity();
...
bool CObjectSentrygunRocketlauncher::Fire()
{
	...
	CGrenadeRocket::Create( vecSrc, vecAim, this->pev, GetOwner() );
