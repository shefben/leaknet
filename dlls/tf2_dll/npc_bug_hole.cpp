...
BEGIN_DATADESC( CMaker_BugHole )
	...
	DEFINE_KEYFIELD( CMaker_BugHole, m_iMaxPool, FIELD_INTEGER, "PoolSize" ),
	DEFINE_KEYFIELD( CMaker_BugHole, m_flPoolRegenTime, FIELD_FLOAT, "PoolRegen" ),
	DEFINE_KEYFIELD( CMaker_BugHole, m_flPatrolTime, FIELD_FLOAT, "PatrolTime" ),
	DEFINE_KEYFIELD( CMaker_BugHole, m_iszPatrolPathName, FIELD_STRING, "PatrolName" ),
	DEFINE_KEYFIELD( CMaker_BugHole, m_iMaxNumberOfPatrollers, FIELD_INTEGER, "MaxPatrollers" ),
	DEFINE_KEYFIELD( CMaker_BugHole, m_iMaxNumberOfBuilders, FIELD_INTEGER, "MaxBuilders" ),
