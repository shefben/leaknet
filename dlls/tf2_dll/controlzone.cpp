...
BEGIN_DATADESC( CControlZone )
	...
	// outputs
	DEFINE_OUTPUT( CControlZone, m_ControllingTeam, "ControllingTeam" ),

	// inputs
	DEFINE_INPUTFUNC( CControlZone, FIELD_VOID, "SetTeam", InputSetTeam ),
	DEFINE_INPUTFUNC( CControlZone, FIELD_VOID, "LockTeam", InputLockControllingTeam ),

	// keys 
	DEFINE_KEYFIELD_NOT_SAVED( CControlZone, m_iLockAfterChange, FIELD_INTEGER, "LockAfterChange" ),
	DEFINE_KEYFIELD_NOT_SAVED( CControlZone, m_flTimeTillCaptured, FIELD_FLOAT, "UncontestedTime" ),
	DEFINE_KEYFIELD_NOT_SAVED( CControlZone, m_flTimeTillContested, FIELD_FLOAT, "ContestedTime" ),
	DEFINE_KEYFIELD_NOT_SAVED( CControlZone, m_nZoneNumber, FIELD_INTEGER, "ZoneNumber" ),
