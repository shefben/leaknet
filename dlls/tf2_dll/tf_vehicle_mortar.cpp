...
#define MORTAR_START_SOUND		"vehicles/diesel_start1.wav"
#define MORTAR_RUNNING_SOUND	"vehicles/diesel_loop2.wav"
...
void CVehicleMortar::Precache()
{
	...
	enginesound->PrecacheSound( MORTAR_START_SOUND );
	enginesound->PrecacheSound( MORTAR_RUNNING_SOUND );
...
{
	SetVehicleSounds( MORTAR_START_SOUND, MORTAR_RUNNING_SOUND, NULL, NULL );
...
void CVehicleMortar::OnFinishedDeploy( void )
{
	...
	CEntityMessageFilter filter( this, "CVehicleMortar" );
	filter.MakeReliable();
