...
BEGIN_DATADESC( CObjectEMPGenerator )
	...
	DEFINE_THINKFUNC( CObjectEMPGenerator, EMPThink ),
...
void CObjectEMPGenerator::EMPThink( void )
{
	...
	for ( CEntitySphereQuery sphere( GetAbsOrigin(), EMPGENERATOR_RADIUS ); pEntity = sphere.GetCurrentEntity(); sphere.NextEntity() )
	{
