...
#define BATTERING_RAM_START_SOUND	"vehicles/diesel_start1.wav"
#define BATTERING_RAM_RUNNING_SOUND "vehicles/diesel_loop2.wav"
#define BATTERING_RAM_TURBO_SOUND	"vehicles/diesel_nitroboost.wav"
...
void CVehicleBatteringRam::Precache()
{
	...
	enginesound->PrecacheSound( BATTERING_RAM_START_SOUND );
	enginesound->PrecacheSound( BATTERING_RAM_RUNNING_SOUND );
	enginesound->PrecacheSound( BATTERING_RAM_TURBO_SOUND );
...
{
	SetVehicleSounds( BATTERING_RAM_START_SOUND, BATTERING_RAM_RUNNING_SOUND, NULL, BATTERING_RAM_TURBO_SOUND );
