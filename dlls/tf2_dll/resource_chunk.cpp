...
const char *sResourceChunkModel = "models/resources/resource_chunk_B.mdl";
const char *sProcessedResourceChunkModel = "models/resources/processed_resource_chunk_B.mdl";

BEGIN_DATADESC( CResourceChunk )

	// functions
	DEFINE_FUNCTION( CResourceChunk, ChunkTouch ),
	DEFINE_FUNCTION( CResourceChunk, ChunkRemove ),
