...
BEGIN_DATADESC( CInfoInputResetBanks )
	...
	// variables
	DEFINE_KEYFIELD( CInfoInputResetBanks, m_iResetAmount, FIELD_INTEGER, "ResetAmount" ),

	// inputs
	DEFINE_INPUTFUNC( CInfoInputResetBanks, FIELD_INTEGER, "SetResetAmount", InputSetResetAmount ),
	DEFINE_INPUTFUNC( CInfoInputResetBanks, FIELD_VOID, "ResetAll", InputResetAll ),
	DEFINE_INPUTFUNC( CInfoInputResetBanks, FIELD_VOID, "ResetTeam1", InputResetTeam1 ),
	DEFINE_INPUTFUNC( CInfoInputResetBanks, FIELD_VOID, "ResetTeam2", InputResetTeam2 ),
	DEFINE_INPUTFUNC( CInfoInputResetBanks, FIELD_EHANDLE, "ResetPlayer", InputResetPlayer ),
