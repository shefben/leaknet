...
// Server is sending heartbeat to Server Master (outdated)
//#define	S2M_HEARTBEAT			'a'	// + challeange + sequence + active + #channels + channels
// Server is sending heartbeat to Master Server
#define	S2M_HEARTBEAT2			'0'	// Look into CMaster::SendHeartbeat for param sequence
