...
// SanyaSho: Interface change description
// GameUI007 (GoldSRC) - No GetSteamPassword;IsInLevel;IsInBackgroundLevel
// GameUI007 (LeakNet) - SetSecondaryProgressBar;SetSecondaryProgressBarText
