...
===================================
*/
void STEAM_RegisterAppProgressCallback( void(*fpProgCallBack)(void), int freq )
{
...
===================================
*/
void STEAM_RegisterAppKeepAliveTicCallback( void(*fpKeepAliveTicCallBack)(char *scr_msg) )
{
