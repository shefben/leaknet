...
enum com_breaksets
{
    COM_BREAKSET_DEFAULT = 0,               // VXP: No colons
    COM_BREAKSET_INCLUDING_COLONS = 1,
    COM_BREAKSET_INCLUDING_PUNCTUATION = 2,
    COM_BREAKSET_WINDOWS_DISALLOWED = 3,
    COM_BREAKSET_WINDOWS_DISALLOWED_INCLUDING_PUNCTUATION = 4
};

extern com_breaksets com_breakset;
...
void COM_Log( const char *pszFile, const char *fmt, ...); // Log a debug message to specified file ( if pszFile == NULL uses c:\\hllog.txt )
