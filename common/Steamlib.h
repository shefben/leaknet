...
extern void STEAM_RegisterAppProgressCallback( void(*fpProgCallBack)(void), int freq );
extern void STEAM_RegisterAppKeepAliveTicCallback( void(*fpKeepAliveTicCallBack)(char* scr_msg) );
