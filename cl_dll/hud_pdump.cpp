	...
	bool networked, bool noterrorchecked, bool differs, bool withintolerance, const char *value )
{
	...
	Q_snprintf( slot->fieldstring, DUMP_STRING_SIZE, "%s %s",
		fieldname,
		value );
...
void CPDumpPanel::Paint()
{
	...
	Q_strcpy( sz, "Not networked, no differences" );
	vgui::localize()->ConvertANSIToUnicode( sz, szconverted, sizeof(szconverted)  );
	surface()->DrawPrintText( szconverted, wcslen( szconverted ) );
	...
	surface()->DrawSetTextColor( Color( r, g, b, a ) );
	surface()->DrawSetTextPos( xpos, y );
	Q_strcpy( sz, "Networked, not checked" );
	vgui::localize()->ConvertANSIToUnicode( sz, szconverted, sizeof(szconverted)  );
	surface()->DrawPrintText( szconverted, wcslen( szconverted ) );
	...
	surface()->DrawSetTextColor( Color( r, g, b, a ) );
	surface()->DrawSetTextPos( xpos, y );
	Q_strcpy( sz, "Networked, error checked" );
	vgui::localize()->ConvertANSIToUnicode( sz, szconverted, sizeof(szconverted)  );
	surface()->DrawPrintText( szconverted, wcslen( szconverted ) );
	...
	surface()->DrawSetTextColor( Color( r, g, b, a ) );
	surface()->DrawSetTextPos( xpos, y );
	Q_strcpy( sz, "Differs, but within tolerance" );
	vgui::localize()->ConvertANSIToUnicode( sz, szconverted, sizeof(szconverted)  );
	surface()->DrawPrintText( szconverted, wcslen( szconverted ) );
	...
	surface()->DrawSetTextColor( Color( r, g, b, a ) );
	surface()->DrawSetTextPos( xpos, y );
	Q_strcpy( sz, "Differs, but not networked" );
	vgui::localize()->ConvertANSIToUnicode( sz, szconverted, sizeof(szconverted)  );
	surface()->DrawPrintText( szconverted, wcslen( szconverted ) );
