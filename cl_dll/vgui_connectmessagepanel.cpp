...
void CConnectMessagePanel::Paint() 
{
	...
	g_pMatSystemSurface->DrawColoredText( m_hFont, x, y, r, g, b, 255, "%s", scr_connectmsg->GetString() );

	if (scr_connectmsg1->GetString()[0] != '0')
	{
		y += vgui::surface()->GetFontTall( m_hFont );
	
		g_pMatSystemSurface->DrawColoredText( m_hFont, x, y, r, g, b, 255, "%s", scr_connectmsg1->GetString() );
	}
	...
	if (scr_connectmsg2->GetString()[0] != '0')
	{
		...
		g_pMatSystemSurface->DrawColoredText( m_hFont, x, y, r, g, b, 255, "%s", scr_connectmsg2->GetString() );
	}
}
