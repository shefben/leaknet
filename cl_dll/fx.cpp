...
//-----------------------------------------------------------------------------
void FX_GunshipImpact( const Vector &pos, float r, float g, float b )
{
...
void GunshipImpactCallback( const CEffectData & data )
{
	...
	FX_GunshipImpact( vecPosition, 0.25f, 0.25f, 0.5f );
}
...
{
	FX_GunshipImpact( data.m_vOrigin, 1.0f, 0.0f, 0.0f );
}
