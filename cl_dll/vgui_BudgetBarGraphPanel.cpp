...
CBudgetBarGraphPanel::CBudgetBarGraphPanel( vgui::Panel *pParent, const char *pPanelName ) : BaseClass( pParent, pPanelName )
{
...
void CBudgetBarGraphPanel::SetRange( float fMin, float fMax )
{
	m_fRangeMin = fMin;
	m_fRangeMax = fMax;
}
