...
bool CTrailParticles::SimulateAndRender( Particle *pInParticle, ParticleDraw *pDraw, float &sortKey )
{
	...
	Tracer_Draw( pDraw, start, vecScaledDelta, flWidth, color );
...
void FX_Sparks( const Vector &pos, int nMagnitude, int nTrailLength, const Vector &vecDir, float flWidth, float flMinSpeed, float flMaxSpeed, const char *pSparkMaterial )
{
