...
//STUB_WEAPON_CLASS( foo_weapon_machinegun, HLMachineGun, C_BaseHLCombatWeapon );
//STUB_WEAPON_CLASS( foo_weapon_select_fire_machinegun, HLSelectFireMachineGun, C_HLMachineGun );
//STUB_WEAPON_CLASS( foo_weapon_basebludgeonweapon, BaseBludgeonWeapon, C_BaseHLCombatWeapon );
