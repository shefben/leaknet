...
BEGIN_PREDICTION_DATA_NO_BASE( CTFPlayerLocalData )
	...
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_nInTacticalView, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_bKnockedDown, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_vecKnockDownDir, FIELD_VECTOR, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_bThermalVision, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
//	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_iIDEntIndex, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_iBankResources, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_ARRAY( CTFPlayerLocalData, m_iResourceAmmo, FIELD_INTEGER, RESOURCE_TYPES, FTYPEDESC_INSENDTABLE ),
	//DEFINE_PRED_ARRAY( CTFPlayerLocalData, m_aObjects, FIELD_EHANDLE, MAX_OBJECTS_PER_PLAYER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_bAttachingSapper, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_flSapperAttachmentFrac, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( CTFPlayerLocalData, m_bForceMapOverview, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
...
BEGIN_PREDICTION_DATA( C_BaseTFPlayer )
	...
	DEFINE_PRED_TYPEDESCRIPTION( C_BaseTFPlayer, m_TFLocal, CTFPlayerLocalData ),
	
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_flCycle, FIELD_FLOAT, FTYPEDESC_INSENDTABLE | FTYPEDESC_PRIVATE | FTYPEDESC_OVERRIDE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_flPlaybackRate, FIELD_FLOAT, FTYPEDESC_INSENDTABLE | FTYPEDESC_PRIVATE | FTYPEDESC_OVERRIDE ),

	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_COMMANDO], C_PlayerClassCommando ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_DEFENDER], C_PlayerClassDefender ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_ESCORT], C_PlayerClassEscort ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_INFILTRATOR], C_PlayerClassInfiltrator ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_MEDIC], C_PlayerClassMedic ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_RECON], C_PlayerClassRecon ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_SNIPER], C_PlayerClassSniper ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_SUPPORT], C_PlayerClassSupport ),
	DEFINE_PRED_TYPEDESCRIPTION_PTR( C_BaseTFPlayer, m_PlayerClasses.m_pClasses[TFCLASS_SAPPER], C_PlayerClassSapper ),

	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_iPlayerClass, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_flCamouflageAmount, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_hSpawnPoint, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_iMaxHealth, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_bDeployed, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_bDeploying, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_bUnDeploying, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_vecDeployedAngles, FIELD_VECTOR, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_iCurrentZoneState, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_TFPlayerFlags, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_bUnderAttack, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),

	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_vecConstraintCenter, FIELD_VECTOR, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_flConstraintRadius, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_flConstraintWidth, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( C_BaseTFPlayer, m_flConstraintSpeedFactor, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),

	DEFINE_FIELD( C_BaseTFPlayer, m_vecPosDelta, FIELD_VECTOR ),
	DEFINE_ARRAY( C_BaseTFPlayer, m_aMomentum, FIELD_FLOAT, C_BaseTFPlayer::MOMENTUM_MAXSIZE ),
	DEFINE_FIELD( C_BaseTFPlayer, m_iMomentumHead, FIELD_INTEGER ),
...
void C_BaseTFPlayer::OnDataChanged( DataUpdateType_t updateType )
{
	...
	if ( bnewentity )
	{
		...
		SetNextClientThink( CLIENT_THINK_ALWAYS );
		m_BoostMaterial.Init( "player/damageboost/thermal" );
		m_EMPMaterial.Init( "player/empeffect" );
	}
...
//-----------------------------------------------------------------------------
void C_BaseTFPlayer::StandardBlendingRules( Vector pos[], Quaternion q[], float currentTime, int boneMask )
{
...
void C_BaseTFPlayer::PerformClientSideObstacleAvoidance( float flFrameTime, CUserCmd *pCmd )
{
	...
	for ( i = 0; i < c; i++ )
	{
		...
		obj->WorldSpaceAABB( &vecWorldMins, &vecWorldMaxs );
...
//-----------------------------------------------------------------------------
void C_BaseTFPlayer::CreateMove( float flFrameTime, float flInputSampleTime, CUserCmd *pCmd )
{
	BaseClass::CreateMove( flFrameTime, flInputSampleTime, pCmd );
	...
	{
		PerformClientSideObstacleAvoidance( flFrameTime, pCmd );
	}
}
