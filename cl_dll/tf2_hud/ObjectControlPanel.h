...
protected:
	...
	vgui::Panel *GetEMPPanel() { return m_pEMPPanel; }
	vgui::Panel *GetUnpoweredPanel() { return m_pUnpoweredPanel; }
	...
	virtual void OnTickUnpowered( C_BaseObject *pObj, C_BaseTFPlayer *pLocalPlayer );
	virtual void OnTickEMP( C_BaseObject *pObj, C_BaseTFPlayer *pLocalPlayer );
...
private:
	...
	vgui::EditablePanel	*m_pEMPPanel;
	vgui::EditablePanel	*m_pUnpoweredPanel;
