...
//-----------------------------------------------------------------------------
int CHudTimer::MsgFunc_SetTimer(const char *pszName, int iSize, void *pbuf )
{
	BEGIN_READ( pbuf, iSize );
	
	float flTimeToSetTo = READ_COORD();
...
//-----------------------------------------------------------------------------
int CHudTimer::MsgFunc_UpdateTimer(const char *pszName, int iSize, void *pbuf )
{
	BEGIN_READ( pbuf, iSize );
...
//-----------------------------------------------------------------------------
int CHudTimer::MsgFunc_StartTimer(const char *pszName, int iSize, void *pbuf )
{
	BEGIN_READ( pbuf, iSize );
