...
public:
	...
	// its ID later.
	virtual int			DrawString( vgui::HFont pCustomFont, int x, int y, int r, int g, int b, int a, int messageID, const char *fmt, ... ) = 0;
	virtual int			DrawString( vgui::HFont pCustomFont, int x, int y, int messageID, const char *fmt, ... ) = 0;
	
	virtual int			DrawStringForTime( float flTime, vgui::HFont pCustomFont, int x, int y, int r, int g, int b, int a, int messageID, const char *fmt,  ... ) = 0;
	virtual int			DrawStringForTime( float flTime, vgui::HFont pCustomFont, int x, int y, int messageID, const char *fmt, ... ) = 0;
